...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_HT'
func (fr *fr_HT) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_HT'
func (fr *fr_HT) FmtMonthYearMedium(t time.Time) string {
