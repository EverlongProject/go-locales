...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_BW'
func (en *en_BW) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_BW'
func (en *en_BW) FmtMonthYearMedium(t time.Time) string {
