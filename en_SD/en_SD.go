...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_SD'
func (en *en_SD) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_SD'
func (en *en_SD) FmtMonthYearMedium(t time.Time) string {
