...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'am_ET'
func (am *am_ET) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'am_ET'
func (am *am_ET) FmtMonthYearMedium(t time.Time) string {
