...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'rw'
func (rw *rw) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'rw'
func (rw *rw) FmtMonthYearMedium(t time.Time) string {
