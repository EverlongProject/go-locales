...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'de_LU'
func (de *de_LU) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'de_LU'
func (de *de_LU) FmtMonthYearMedium(t time.Time) string {
