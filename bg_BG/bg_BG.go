...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bg_BG'
func (bg *bg_BG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bg_BG'
func (bg *bg_BG) FmtMonthYearMedium(t time.Time) string {
