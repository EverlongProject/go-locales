...
func New() locales.Translator {
	return &os_RU{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"GMT": "Гринвичы рӕстӕмбис рӕстӕг", "MESZ": "Астӕуккаг Европӕйаг сӕрдыгон рӕстӕг", "MEZ": "Астӕуккаг Европӕйаг стандартон рӕстӕг", "OESZ": "Скӕсӕн Европӕйаг сӕрдыгон рӕстӕг", "OEZ": "Скӕсӕн Европӕйаг стандартон рӕстӕг", "WESZ": "Ныгъуылӕн Европӕйаг сӕрдыгон рӕстӕг", "WEZ": "Ныгъуылӕн Европӕйаг стандартон рӕстӕг"},
	}
}
...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'os_RU'
func (os *os_RU) FmtMonthDayMedium(t time.Time) string {
	...
	b = append(b, []byte{0x20}...)
	b = append(b, os.monthsAbbreviated[t.Month()]...)
	b = append(b, []byte{0xd0, 0xb0, 0xd0, 0xb7}...)

	return string(b)
}

// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'os_RU'
func (os *os_RU) FmtMonthYearMedium(t time.Time) string {
