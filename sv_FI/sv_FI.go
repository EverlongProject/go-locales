...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sv_FI'
func (sv *sv_FI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sv_FI'
func (sv *sv_FI) FmtMonthYearMedium(t time.Time) string {
