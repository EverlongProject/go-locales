...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ak_GH'
func (ak *ak_GH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ak_GH'
func (ak *ak_GH) FmtMonthYearMedium(t time.Time) string {
