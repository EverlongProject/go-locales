...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_JO'
func (ar *ar_JO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_JO'
func (ar *ar_JO) FmtMonthYearMedium(t time.Time) string {
