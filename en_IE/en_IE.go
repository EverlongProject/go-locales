...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_IE'
func (en *en_IE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_IE'
func (en *en_IE) FmtMonthYearMedium(t time.Time) string {
