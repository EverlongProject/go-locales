...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'zh_Hans'
func (zh *zh_Hans) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'zh_Hans'
func (zh *zh_Hans) FmtMonthYearMedium(t time.Time) string {
