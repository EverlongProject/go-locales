...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ee_TG'
func (ee *ee_TG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ee_TG'
func (ee *ee_TG) FmtMonthYearMedium(t time.Time) string {
