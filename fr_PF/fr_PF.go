...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_PF'
func (fr *fr_PF) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_PF'
func (fr *fr_PF) FmtMonthYearMedium(t time.Time) string {
