...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ce_RU'
func (ce *ce_RU) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ce_RU'
func (ce *ce_RU) FmtMonthYearMedium(t time.Time) string {
