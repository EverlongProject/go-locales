...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'dua'
func (dua *dua) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'dua'
func (dua *dua) FmtMonthYearMedium(t time.Time) string {
