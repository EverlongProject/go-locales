...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kea'
func (kea *kea) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kea'
func (kea *kea) FmtMonthYearMedium(t time.Time) string {
