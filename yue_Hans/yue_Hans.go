...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'yue_Hans'
func (yue *yue_Hans) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'yue_Hans'
func (yue *yue_Hans) FmtMonthYearMedium(t time.Time) string {
