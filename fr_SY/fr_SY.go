...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_SY'
func (fr *fr_SY) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_SY'
func (fr *fr_SY) FmtMonthYearMedium(t time.Time) string {
