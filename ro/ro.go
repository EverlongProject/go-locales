...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ro'
func (ro *ro) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ro'
func (ro *ro) FmtMonthYearMedium(t time.Time) string {
