...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ga_GB'
func (ga *ga_GB) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ga_GB'
func (ga *ga_GB) FmtMonthYearMedium(t time.Time) string {
