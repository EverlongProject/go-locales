...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mk_MK'
func (mk *mk_MK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mk_MK'
func (mk *mk_MK) FmtMonthYearMedium(t time.Time) string {
