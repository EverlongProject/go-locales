...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_RW'
func (en *en_RW) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_RW'
func (en *en_RW) FmtMonthYearMedium(t time.Time) string {
