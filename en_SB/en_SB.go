...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_SB'
func (en *en_SB) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_SB'
func (en *en_SB) FmtMonthYearMedium(t time.Time) string {
