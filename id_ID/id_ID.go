...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'id_ID'
func (id *id_ID) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'id_ID'
func (id *id_ID) FmtMonthYearMedium(t time.Time) string {
