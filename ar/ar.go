...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar'
func (ar *ar) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar'
func (ar *ar) FmtMonthYearMedium(t time.Time) string {
