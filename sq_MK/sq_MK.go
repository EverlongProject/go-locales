...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sq_MK'
func (sq *sq_MK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sq_MK'
func (sq *sq_MK) FmtMonthYearMedium(t time.Time) string {
