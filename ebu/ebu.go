...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ebu'
func (ebu *ebu) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ebu'
func (ebu *ebu) FmtMonthYearMedium(t time.Time) string {
