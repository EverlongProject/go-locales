...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_MC'
func (fr *fr_MC) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_MC'
func (fr *fr_MC) FmtMonthYearMedium(t time.Time) string {
