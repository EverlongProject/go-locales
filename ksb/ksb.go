...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ksb'
func (ksb *ksb) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ksb'
func (ksb *ksb) FmtMonthYearMedium(t time.Time) string {
