...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ta_LK'
func (ta *ta_LK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ta_LK'
func (ta *ta_LK) FmtMonthYearMedium(t time.Time) string {
