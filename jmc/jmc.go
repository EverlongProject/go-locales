...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'jmc'
func (jmc *jmc) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'jmc'
func (jmc *jmc) FmtMonthYearMedium(t time.Time) string {
