...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_PH'
func (en *en_PH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_PH'
func (en *en_PH) FmtMonthYearMedium(t time.Time) string {
