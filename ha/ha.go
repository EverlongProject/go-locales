...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ha'
func (ha *ha) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ha'
func (ha *ha) FmtMonthYearMedium(t time.Time) string {
