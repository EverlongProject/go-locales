...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'so_SO'
func (so *so_SO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'so_SO'
func (so *so_SO) FmtMonthYearMedium(t time.Time) string {
