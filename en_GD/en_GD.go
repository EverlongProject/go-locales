...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_GD'
func (en *en_GD) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_GD'
func (en *en_GD) FmtMonthYearMedium(t time.Time) string {
