...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'cs_CZ'
func (cs *cs_CZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'cs_CZ'
func (cs *cs_CZ) FmtMonthYearMedium(t time.Time) string {
