...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'hr'
func (hr *hr) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'hr'
func (hr *hr) FmtMonthYearMedium(t time.Time) string {
