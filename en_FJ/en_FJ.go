...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_FJ'
func (en *en_FJ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_FJ'
func (en *en_FJ) FmtMonthYearMedium(t time.Time) string {
