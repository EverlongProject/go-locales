...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'qu_BO'
func (qu *qu_BO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'qu_BO'
func (qu *qu_BO) FmtMonthYearMedium(t time.Time) string {
