...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ks'
func (ks *ks) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ks'
func (ks *ks) FmtMonthYearMedium(t time.Time) string {
