...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nyn'
func (nyn *nyn) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nyn'
func (nyn *nyn) FmtMonthYearMedium(t time.Time) string {
