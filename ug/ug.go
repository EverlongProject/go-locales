...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ug'
func (ug *ug) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ug'
func (ug *ug) FmtMonthYearMedium(t time.Time) string {
