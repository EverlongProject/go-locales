...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_TZ'
func (en *en_TZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_TZ'
func (en *en_TZ) FmtMonthYearMedium(t time.Time) string {
