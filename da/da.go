...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'da'
func (da *da) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'da'
func (da *da) FmtMonthYearMedium(t time.Time) string {
