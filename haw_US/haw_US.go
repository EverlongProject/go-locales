...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'haw_US'
func (haw *haw_US) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'haw_US'
func (haw *haw_US) FmtMonthYearMedium(t time.Time) string {
