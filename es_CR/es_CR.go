...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_CR'
func (es *es_CR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_CR'
func (es *es_CR) FmtMonthYearMedium(t time.Time) string {
