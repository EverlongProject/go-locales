...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_NL'
func (en *en_NL) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_NL'
func (en *en_NL) FmtMonthYearMedium(t time.Time) string {
