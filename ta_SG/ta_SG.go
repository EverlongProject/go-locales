...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ta_SG'
func (ta *ta_SG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ta_SG'
func (ta *ta_SG) FmtMonthYearMedium(t time.Time) string {
