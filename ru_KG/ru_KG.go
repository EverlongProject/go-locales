...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ru_KG'
func (ru *ru_KG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ru_KG'
func (ru *ru_KG) FmtMonthYearMedium(t time.Time) string {
