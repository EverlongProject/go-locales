...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_001'
func (en *en_001) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_001'
func (en *en_001) FmtMonthYearMedium(t time.Time) string {
