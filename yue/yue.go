...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'yue'
func (yue *yue) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'yue'
func (yue *yue) FmtMonthYearMedium(t time.Time) string {
