...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'shi_Tfng_MA'
func (shi *shi_Tfng_MA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'shi_Tfng_MA'
func (shi *shi_Tfng_MA) FmtMonthYearMedium(t time.Time) string {
