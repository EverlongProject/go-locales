...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nmg_CM'
func (nmg *nmg_CM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nmg_CM'
func (nmg *nmg_CM) FmtMonthYearMedium(t time.Time) string {
