...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_MR'
func (ar *ar_MR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_MR'
func (ar *ar_MR) FmtMonthYearMedium(t time.Time) string {
