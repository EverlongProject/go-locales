...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'xog_UG'
func (xog *xog_UG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'xog_UG'
func (xog *xog_UG) FmtMonthYearMedium(t time.Time) string {
