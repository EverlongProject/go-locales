...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_LR'
func (en *en_LR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_LR'
func (en *en_LR) FmtMonthYearMedium(t time.Time) string {
