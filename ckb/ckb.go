...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ckb'
func (ckb *ckb) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ckb'
func (ckb *ckb) FmtMonthYearMedium(t time.Time) string {
