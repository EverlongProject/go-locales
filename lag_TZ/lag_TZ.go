...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lag_TZ'
func (lag *lag_TZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lag_TZ'
func (lag *lag_TZ) FmtMonthYearMedium(t time.Time) string {
