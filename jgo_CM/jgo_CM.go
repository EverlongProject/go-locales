...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'jgo_CM'
func (jgo *jgo_CM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'jgo_CM'
func (jgo *jgo_CM) FmtMonthYearMedium(t time.Time) string {
