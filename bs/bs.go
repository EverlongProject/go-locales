...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bs'
func (bs *bs) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bs'
func (bs *bs) FmtMonthYearMedium(t time.Time) string {
