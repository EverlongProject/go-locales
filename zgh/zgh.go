...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'zgh'
func (zgh *zgh) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'zgh'
func (zgh *zgh) FmtMonthYearMedium(t time.Time) string {
