...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ky_KG'
func (ky *ky_KG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ky_KG'
func (ky *ky_KG) FmtMonthYearMedium(t time.Time) string {
	...
	b = append(b, []byte{0x2d, 0xd0, 0xb6}...)
	b = append(b, []byte{0x2e, 0x20, 0x2d}...)
	b = append(b, ky.monthsAbbreviated[t.Month()]...)
