...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_JE'
func (en *en_JE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_JE'
func (en *en_JE) FmtMonthYearMedium(t time.Time) string {
