...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'az'
func (az *az) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'az'
func (az *az) FmtMonthYearMedium(t time.Time) string {
