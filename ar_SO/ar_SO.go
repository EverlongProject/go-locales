...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_SO'
func (ar *ar_SO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_SO'
func (ar *ar_SO) FmtMonthYearMedium(t time.Time) string {
