...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_CA'
func (en *en_CA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_CA'
func (en *en_CA) FmtMonthYearMedium(t time.Time) string {
