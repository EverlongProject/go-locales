...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ta'
func (ta *ta) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ta'
func (ta *ta) FmtMonthYearMedium(t time.Time) string {
