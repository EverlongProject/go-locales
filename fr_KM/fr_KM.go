...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_KM'
func (fr *fr_KM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_KM'
func (fr *fr_KM) FmtMonthYearMedium(t time.Time) string {
