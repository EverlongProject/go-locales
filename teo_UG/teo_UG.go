...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'teo_UG'
func (teo *teo_UG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'teo_UG'
func (teo *teo_UG) FmtMonthYearMedium(t time.Time) string {
