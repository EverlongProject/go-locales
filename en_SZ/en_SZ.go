...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_SZ'
func (en *en_SZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_SZ'
func (en *en_SZ) FmtMonthYearMedium(t time.Time) string {
