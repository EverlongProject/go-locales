...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'hr_BA'
func (hr *hr_BA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'hr_BA'
func (hr *hr_BA) FmtMonthYearMedium(t time.Time) string {
