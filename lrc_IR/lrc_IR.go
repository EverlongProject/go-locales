...
func New() locales.Translator {
	return &lrc_IR{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"CDT": "روٙشنایی نئهادار روٙز", "CST": "گاٛت مینجاٛیی ئستاٛنداٛرد"},
	}
}
...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lrc_IR'
func (lrc *lrc_IR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lrc_IR'
func (lrc *lrc_IR) FmtMonthYearMedium(t time.Time) string {
