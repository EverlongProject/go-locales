...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ta_IN'
func (ta *ta_IN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ta_IN'
func (ta *ta_IN) FmtMonthYearMedium(t time.Time) string {
