...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mgh'
func (mgh *mgh) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mgh'
func (mgh *mgh) FmtMonthYearMedium(t time.Time) string {
