...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_LU'
func (fr *fr_LU) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_LU'
func (fr *fr_LU) FmtMonthYearMedium(t time.Time) string {
