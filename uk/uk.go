...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'uk'
func (uk *uk) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'uk'
func (uk *uk) FmtMonthYearMedium(t time.Time) string {
