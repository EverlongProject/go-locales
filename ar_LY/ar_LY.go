...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_LY'
func (ar *ar_LY) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_LY'
func (ar *ar_LY) FmtMonthYearMedium(t time.Time) string {
