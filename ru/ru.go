...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ru'
func (ru *ru) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ru'
func (ru *ru) FmtMonthYearMedium(t time.Time) string {
