...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ig_NG'
func (ig *ig_NG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ig_NG'
func (ig *ig_NG) FmtMonthYearMedium(t time.Time) string {
