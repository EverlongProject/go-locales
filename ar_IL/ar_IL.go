...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_IL'
func (ar *ar_IL) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_IL'
func (ar *ar_IL) FmtMonthYearMedium(t time.Time) string {
