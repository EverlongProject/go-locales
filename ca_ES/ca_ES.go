...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ca_ES'
func (ca *ca_ES) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ca_ES'
func (ca *ca_ES) FmtMonthYearMedium(t time.Time) string {
