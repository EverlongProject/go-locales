...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_MY'
func (en *en_MY) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_MY'
func (en *en_MY) FmtMonthYearMedium(t time.Time) string {
