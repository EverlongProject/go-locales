...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'zh_Hans_HK'
func (zh *zh_Hans_HK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'zh_Hans_HK'
func (zh *zh_Hans_HK) FmtMonthYearMedium(t time.Time) string {
