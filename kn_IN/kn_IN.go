...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kn_IN'
func (kn *kn_IN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kn_IN'
func (kn *kn_IN) FmtMonthYearMedium(t time.Time) string {
