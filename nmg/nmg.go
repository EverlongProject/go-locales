...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nmg'
func (nmg *nmg) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nmg'
func (nmg *nmg) FmtMonthYearMedium(t time.Time) string {
