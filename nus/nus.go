...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nus'
func (nus *nus) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nus'
func (nus *nus) FmtMonthYearMedium(t time.Time) string {
