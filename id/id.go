...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'id'
func (id *id) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'id'
func (id *id) FmtMonthYearMedium(t time.Time) string {
