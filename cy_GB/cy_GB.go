...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'cy_GB'
func (cy *cy_GB) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'cy_GB'
func (cy *cy_GB) FmtMonthYearMedium(t time.Time) string {
