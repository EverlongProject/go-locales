...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ka'
func (ka *ka) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ka'
func (ka *ka) FmtMonthYearMedium(t time.Time) string {
