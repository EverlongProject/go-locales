...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kam'
func (kam *kam) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kam'
func (kam *kam) FmtMonthYearMedium(t time.Time) string {
