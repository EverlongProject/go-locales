...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_CO'
func (es *es_CO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_CO'
func (es *es_CO) FmtMonthYearMedium(t time.Time) string {
