...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mr'
func (mr *mr) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mr'
func (mr *mr) FmtMonthYearMedium(t time.Time) string {
