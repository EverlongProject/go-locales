...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'zh_Hans_SG'
func (zh *zh_Hans_SG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'zh_Hans_SG'
func (zh *zh_Hans_SG) FmtMonthYearMedium(t time.Time) string {
