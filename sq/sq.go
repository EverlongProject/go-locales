...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sq'
func (sq *sq) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sq'
func (sq *sq) FmtMonthYearMedium(t time.Time) string {
