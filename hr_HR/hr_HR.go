...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'hr_HR'
func (hr *hr_HR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'hr_HR'
func (hr *hr_HR) FmtMonthYearMedium(t time.Time) string {
