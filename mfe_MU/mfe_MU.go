...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mfe_MU'
func (mfe *mfe_MU) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mfe_MU'
func (mfe *mfe_MU) FmtMonthYearMedium(t time.Time) string {
