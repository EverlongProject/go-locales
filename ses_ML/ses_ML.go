...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ses_ML'
func (ses *ses_ML) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ses_ML'
func (ses *ses_ML) FmtMonthYearMedium(t time.Time) string {
