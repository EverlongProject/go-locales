...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'yo_BJ'
func (yo *yo_BJ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'yo_BJ'
func (yo *yo_BJ) FmtMonthYearMedium(t time.Time) string {
