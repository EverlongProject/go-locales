...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ff_SN'
func (ff *ff_SN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ff_SN'
func (ff *ff_SN) FmtMonthYearMedium(t time.Time) string {
