...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_IL'
func (en *en_IL) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_IL'
func (en *en_IL) FmtMonthYearMedium(t time.Time) string {
