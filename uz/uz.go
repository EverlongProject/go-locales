...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'uz'
func (uz *uz) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'uz'
func (uz *uz) FmtMonthYearMedium(t time.Time) string {
