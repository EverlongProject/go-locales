...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fa'
func (fa *fa) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fa'
func (fa *fa) FmtMonthYearMedium(t time.Time) string {
