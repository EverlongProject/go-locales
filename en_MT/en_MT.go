...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_MT'
func (en *en_MT) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_MT'
func (en *en_MT) FmtMonthYearMedium(t time.Time) string {
