...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_CM'
func (en *en_CM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_CM'
func (en *en_CM) FmtMonthYearMedium(t time.Time) string {
