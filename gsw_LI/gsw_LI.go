...
func New() locales.Translator {
	return &gsw_LI{
		...
		timezones:              map[string]string{"AKDT": "Alaska-Summerziit", "AKST": "Alaska-Schtandardziit", "CAT": "Zentralafrikanischi Ziit", "CDT": "Amerika-Zentraal Summerziit", "CST": "Amerika-Zentraal Schtandardziit", "EAT": "Oschtafrikanischi Ziit", "MESZ": "Mitteleuropäischi Summerziit", "MEZ": "Mitteleuropäischi Schtandardziit", "OESZ": "Oschteuropäischi Summerziit", "OEZ": "Oschteuropäischi Schtandardziit", "SAST": "Süüdafrikanischi ziit", "WAST": "Weschtafrikanischi Summerziit", "WAT": "Weschtafrikanischi Schtandardziit", "WESZ": "Weschteuropäischi Summerziit", "WEZ": "Weschteuropäischi Schtandardziit", "∅∅∅": "Amazonas-Summerziit"},
	}
}
...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'gsw_LI'
func (gsw *gsw_LI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'gsw_LI'
func (gsw *gsw_LI) FmtMonthYearMedium(t time.Time) string {
