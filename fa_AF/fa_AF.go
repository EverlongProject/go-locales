...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fa_AF'
func (fa *fa_AF) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fa_AF'
func (fa *fa_AF) FmtMonthYearMedium(t time.Time) string {
