...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pt_LU'
func (pt *pt_LU) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pt_LU'
func (pt *pt_LU) FmtMonthYearMedium(t time.Time) string {
