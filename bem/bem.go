...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bem'
func (bem *bem) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bem'
func (bem *bem) FmtMonthYearMedium(t time.Time) string {
