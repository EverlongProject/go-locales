...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_ZA'
func (en *en_ZA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_ZA'
func (en *en_ZA) FmtMonthYearMedium(t time.Time) string {
