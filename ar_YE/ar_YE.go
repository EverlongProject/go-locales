...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_YE'
func (ar *ar_YE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_YE'
func (ar *ar_YE) FmtMonthYearMedium(t time.Time) string {
