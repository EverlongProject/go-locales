...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sv_SE'
func (sv *sv_SE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sv_SE'
func (sv *sv_SE) FmtMonthYearMedium(t time.Time) string {
