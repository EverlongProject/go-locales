...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'gu_IN'
func (gu *gu_IN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'gu_IN'
func (gu *gu_IN) FmtMonthYearMedium(t time.Time) string {
