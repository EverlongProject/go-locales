...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_NZ'
func (en *en_NZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_NZ'
func (en *en_NZ) FmtMonthYearMedium(t time.Time) string {
