...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fil_PH'
func (fil *fil_PH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fil_PH'
func (fil *fil_PH) FmtMonthYearMedium(t time.Time) string {
