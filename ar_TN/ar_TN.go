...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_TN'
func (ar *ar_TN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_TN'
func (ar *ar_TN) FmtMonthYearMedium(t time.Time) string {
