...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ses'
func (ses *ses) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ses'
func (ses *ses) FmtMonthYearMedium(t time.Time) string {
