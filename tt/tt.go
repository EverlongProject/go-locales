...
func New() locales.Translator {
	return &tt{
		...
		timezones:          map[string]string{"ADT": "Төньяк Америка җәйге атлантик вакыты", "AST": "Төньяк Америка гадәти атлантик вакыты", "CDT": "Төньяк Америка җәйге үзәк вакыты", "CST": "Төньяк Америка гадәти үзәк вакыты", "EDT": "Төньяк Америка җәйге көнчыгыш вакыты", "EST": "Төньяк Америка гадәти көнчыгыш вакыты", "GMT": "Гринвич уртача вакыты", "MDT": "Төньяк Америка җәйге тау вакыты", "MESZ": "җәйге Үзәк Европа вакыты", "MEZ": "гадәти Үзәк Европа вакыты", "MST": "Төньяк Америка гадәти тау вакыты", "OESZ": "җәйге Көнчыгыш Европа вакыты", "OEZ": "гадәти Көнчыгыш Европа вакыты", "PDT": "Төньяк Америка җәйге Тын океан вакыты", "PST": "Төньяк Америка гадәти Тын океан вакыты", "WESZ": "җәйге Көнбатыш Европа вакыты", "WEZ": "гадәти Көнбатыш Европа вакыты"},
	}
}
...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'tt'
func (tt *tt) FmtMonthDayMedium(t time.Time) string {
	...
	b = append(b, []byte{0x20}...)
	b = append(b, tt.monthsAbbreviated[t.Month()]...)
	b = append(b, []byte{0xd0, 0xb5, 0xd0, 0xbb}...)

	return string(b)
}

// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'tt'
func (tt *tt) FmtMonthYearMedium(t time.Time) string {
