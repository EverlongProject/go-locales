...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'se_FI'
func (se *se_FI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'se_FI'
func (se *se_FI) FmtMonthYearMedium(t time.Time) string {
