...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_AE'
func (ar *ar_AE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_AE'
func (ar *ar_AE) FmtMonthYearMedium(t time.Time) string {
