...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ak'
func (ak *ak) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ak'
func (ak *ak) FmtMonthYearMedium(t time.Time) string {
