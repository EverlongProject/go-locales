...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'luy'
func (luy *luy) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'luy'
func (luy *luy) FmtMonthYearMedium(t time.Time) string {
