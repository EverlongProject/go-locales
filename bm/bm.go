...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bm'
func (bm *bm) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bm'
func (bm *bm) FmtMonthYearMedium(t time.Time) string {
