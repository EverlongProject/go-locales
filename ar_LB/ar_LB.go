...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_LB'
func (ar *ar_LB) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_LB'
func (ar *ar_LB) FmtMonthYearMedium(t time.Time) string {
