...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_PK'
func (en *en_PK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_PK'
func (en *en_PK) FmtMonthYearMedium(t time.Time) string {
