...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ti'
func (ti *ti) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ti'
func (ti *ti) FmtMonthYearMedium(t time.Time) string {
