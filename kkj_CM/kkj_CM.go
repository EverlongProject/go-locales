...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kkj_CM'
func (kkj *kkj_CM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kkj_CM'
func (kkj *kkj_CM) FmtMonthYearMedium(t time.Time) string {
