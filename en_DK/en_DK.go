...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_DK'
func (en *en_DK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_DK'
func (en *en_DK) FmtMonthYearMedium(t time.Time) string {
