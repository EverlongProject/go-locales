...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_CU'
func (es *es_CU) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_CU'
func (es *es_CU) FmtMonthYearMedium(t time.Time) string {
