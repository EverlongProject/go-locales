...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ru_RU'
func (ru *ru_RU) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ru_RU'
func (ru *ru_RU) FmtMonthYearMedium(t time.Time) string {
