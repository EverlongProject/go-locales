...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'gv_IM'
func (gv *gv_IM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'gv_IM'
func (gv *gv_IM) FmtMonthYearMedium(t time.Time) string {
