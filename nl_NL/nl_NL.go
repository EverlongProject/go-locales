...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nl_NL'
func (nl *nl_NL) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nl_NL'
func (nl *nl_NL) FmtMonthYearMedium(t time.Time) string {
