...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bas'
func (bas *bas) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bas'
func (bas *bas) FmtMonthYearMedium(t time.Time) string {
