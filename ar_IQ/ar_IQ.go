...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_IQ'
func (ar *ar_IQ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_IQ'
func (ar *ar_IQ) FmtMonthYearMedium(t time.Time) string {
