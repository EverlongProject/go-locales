...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_PS'
func (ar *ar_PS) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_PS'
func (ar *ar_PS) FmtMonthYearMedium(t time.Time) string {
