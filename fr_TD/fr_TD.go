...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_TD'
func (fr *fr_TD) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_TD'
func (fr *fr_TD) FmtMonthYearMedium(t time.Time) string {
