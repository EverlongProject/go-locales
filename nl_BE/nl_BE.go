...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nl_BE'
func (nl *nl_BE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nl_BE'
func (nl *nl_BE) FmtMonthYearMedium(t time.Time) string {
