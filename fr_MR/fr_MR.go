...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_MR'
func (fr *fr_MR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_MR'
func (fr *fr_MR) FmtMonthYearMedium(t time.Time) string {
