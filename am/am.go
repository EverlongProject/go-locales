...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'am'
func (am *am) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'am'
func (am *am) FmtMonthYearMedium(t time.Time) string {
