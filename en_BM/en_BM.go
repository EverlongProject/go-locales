...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_BM'
func (en *en_BM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_BM'
func (en *en_BM) FmtMonthYearMedium(t time.Time) string {
