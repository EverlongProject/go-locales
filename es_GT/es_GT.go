...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_GT'
func (es *es_GT) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_GT'
func (es *es_GT) FmtMonthYearMedium(t time.Time) string {
