...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'et_EE'
func (et *et_EE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'et_EE'
func (et *et_EE) FmtMonthYearMedium(t time.Time) string {
