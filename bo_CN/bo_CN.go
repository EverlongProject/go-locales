...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bo_CN'
func (bo *bo_CN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bo_CN'
func (bo *bo_CN) FmtMonthYearMedium(t time.Time) string {
