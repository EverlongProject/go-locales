...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'br_FR'
func (br *br_FR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'br_FR'
func (br *br_FR) FmtMonthYearMedium(t time.Time) string {
