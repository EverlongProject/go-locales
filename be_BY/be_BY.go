...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'be_BY'
func (be *be_BY) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'be_BY'
func (be *be_BY) FmtMonthYearMedium(t time.Time) string {
