...
func New() locales.Translator {
	return &tg_TJ{
		...
		timezones:              map[string]string{"ADT": "Вақти рӯзонаи атлантикӣ", "AST": "Вақти стандартии атлантикӣ", "CDT": "Вақти рӯзонаи марказӣ", "CST": "Вақти стандартии марказӣ", "EDT": "Вақти рӯзонаи шарқӣ", "EST": "Вақти стандартии шарқӣ", "GMT": "Ба вақти Гринвич", "MDT": "Вақти рӯзонаи кӯҳӣ", "MESZ": "Вақти тобистонаи аврупоии марказӣ", "MEZ": "Вақти стандартии аврупоии марказӣ", "MST": "Вақти стандартии кӯҳӣ", "OESZ": "Вақти тобистонаи аврупоии шарқӣ", "OEZ": "Вақти стандартии аврупоии шарқӣ", "PDT": "Вақти рӯзонаи Уқёнуси Ором", "PST": "Вақти стандартии Уқёнуси Ором", "WESZ": "Вақти тобистонаи аврупоии ғарбӣ", "WEZ": "Вақти стандартии аврупоии ғарбӣ"},
	}
}
...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'tg_TJ'
func (tg *tg_TJ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'tg_TJ'
func (tg *tg_TJ) FmtMonthYearMedium(t time.Time) string {
