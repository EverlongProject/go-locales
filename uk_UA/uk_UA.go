...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'uk_UA'
func (uk *uk_UA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'uk_UA'
func (uk *uk_UA) FmtMonthYearMedium(t time.Time) string {
