...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_DZ'
func (ar *ar_DZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_DZ'
func (ar *ar_DZ) FmtMonthYearMedium(t time.Time) string {
