...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bs_Latn'
func (bs *bs_Latn) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bs_Latn'
func (bs *bs_Latn) FmtMonthYearMedium(t time.Time) string {
