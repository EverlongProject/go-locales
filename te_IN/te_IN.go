...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'te_IN'
func (te *te_IN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'te_IN'
func (te *te_IN) FmtMonthYearMedium(t time.Time) string {
