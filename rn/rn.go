...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'rn'
func (rn *rn) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'rn'
func (rn *rn) FmtMonthYearMedium(t time.Time) string {
