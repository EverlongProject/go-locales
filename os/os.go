...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'os'
func (os *os) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'os'
func (os *os) FmtMonthYearMedium(t time.Time) string {
