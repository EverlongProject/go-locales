...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kab'
func (kab *kab) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kab'
func (kab *kab) FmtMonthYearMedium(t time.Time) string {
