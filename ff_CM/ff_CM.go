...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ff_CM'
func (ff *ff_CM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ff_CM'
func (ff *ff_CM) FmtMonthYearMedium(t time.Time) string {
