...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_BE'
func (fr *fr_BE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_BE'
func (fr *fr_BE) FmtMonthYearMedium(t time.Time) string {
