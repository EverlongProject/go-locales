...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_TT'
func (en *en_TT) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_TT'
func (en *en_TT) FmtMonthYearMedium(t time.Time) string {
