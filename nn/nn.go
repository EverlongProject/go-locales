...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nn'
func (nn *nn) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nn'
func (nn *nn) FmtMonthYearMedium(t time.Time) string {
