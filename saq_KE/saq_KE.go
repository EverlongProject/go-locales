...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'saq_KE'
func (saq *saq_KE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'saq_KE'
func (saq *saq_KE) FmtMonthYearMedium(t time.Time) string {
