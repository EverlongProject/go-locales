...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'vo_001'
func (vo *vo_001) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'vo_001'
func (vo *vo_001) FmtMonthYearMedium(t time.Time) string {
