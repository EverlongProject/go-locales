...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bm_ML'
func (bm *bm_ML) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bm_ML'
func (bm *bm_ML) FmtMonthYearMedium(t time.Time) string {
