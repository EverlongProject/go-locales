...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nn_NO'
func (nn *nn_NO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nn_NO'
func (nn *nn_NO) FmtMonthYearMedium(t time.Time) string {
