...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ti_ET'
func (ti *ti_ET) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ti_ET'
func (ti *ti_ET) FmtMonthYearMedium(t time.Time) string {
