...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_MF'
func (fr *fr_MF) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_MF'
func (fr *fr_MF) FmtMonthYearMedium(t time.Time) string {
