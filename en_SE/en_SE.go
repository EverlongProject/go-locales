...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_SE'
func (en *en_SE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_SE'
func (en *en_SE) FmtMonthYearMedium(t time.Time) string {
