...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mg_MG'
func (mg *mg_MG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mg_MG'
func (mg *mg_MG) FmtMonthYearMedium(t time.Time) string {
