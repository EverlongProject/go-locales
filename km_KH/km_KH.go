...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'km_KH'
func (km *km_KH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'km_KH'
func (km *km_KH) FmtMonthYearMedium(t time.Time) string {
