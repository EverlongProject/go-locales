...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sn_ZW'
func (sn *sn_ZW) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sn_ZW'
func (sn *sn_ZW) FmtMonthYearMedium(t time.Time) string {
