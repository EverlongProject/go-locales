...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'xog'
func (xog *xog) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'xog'
func (xog *xog) FmtMonthYearMedium(t time.Time) string {
