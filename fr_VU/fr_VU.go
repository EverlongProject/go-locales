...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_VU'
func (fr *fr_VU) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_VU'
func (fr *fr_VU) FmtMonthYearMedium(t time.Time) string {
