...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ru_UA'
func (ru *ru_UA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ru_UA'
func (ru *ru_UA) FmtMonthYearMedium(t time.Time) string {
