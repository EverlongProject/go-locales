...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mer'
func (mer *mer) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mer'
func (mer *mer) FmtMonthYearMedium(t time.Time) string {
