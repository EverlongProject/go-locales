...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'cgg'
func (cgg *cgg) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'cgg'
func (cgg *cgg) FmtMonthYearMedium(t time.Time) string {
