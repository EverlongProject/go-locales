...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ee_GH'
func (ee *ee_GH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ee_GH'
func (ee *ee_GH) FmtMonthYearMedium(t time.Time) string {
