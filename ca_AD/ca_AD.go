...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ca_AD'
func (ca *ca_AD) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ca_AD'
func (ca *ca_AD) FmtMonthYearMedium(t time.Time) string {
