...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_LS'
func (en *en_LS) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_LS'
func (en *en_LS) FmtMonthYearMedium(t time.Time) string {
