...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ps_AF'
func (ps *ps_AF) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ps_AF'
func (ps *ps_AF) FmtMonthYearMedium(t time.Time) string {
