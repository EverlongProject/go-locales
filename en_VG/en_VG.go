...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_VG'
func (en *en_VG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_VG'
func (en *en_VG) FmtMonthYearMedium(t time.Time) string {
