...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_TO'
func (en *en_TO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_TO'
func (en *en_TO) FmtMonthYearMedium(t time.Time) string {
