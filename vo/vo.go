...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'vo'
func (vo *vo) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'vo'
func (vo *vo) FmtMonthYearMedium(t time.Time) string {
