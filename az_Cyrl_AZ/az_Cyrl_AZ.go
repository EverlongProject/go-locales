...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'az_Cyrl_AZ'
func (az *az_Cyrl_AZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'az_Cyrl_AZ'
func (az *az_Cyrl_AZ) FmtMonthYearMedium(t time.Time) string {
