...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'yi'
func (yi *yi) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'yi'
func (yi *yi) FmtMonthYearMedium(t time.Time) string {
