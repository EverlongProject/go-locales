...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nd'
func (nd *nd) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nd'
func (nd *nd) FmtMonthYearMedium(t time.Time) string {
