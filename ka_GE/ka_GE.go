...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ka_GE'
func (ka *ka_GE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ka_GE'
func (ka *ka_GE) FmtMonthYearMedium(t time.Time) string {
