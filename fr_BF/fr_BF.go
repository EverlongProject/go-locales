...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_BF'
func (fr *fr_BF) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_BF'
func (fr *fr_BF) FmtMonthYearMedium(t time.Time) string {
