...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sbp'
func (sbp *sbp) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sbp'
func (sbp *sbp) FmtMonthYearMedium(t time.Time) string {
