...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'rwk_TZ'
func (rwk *rwk_TZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'rwk_TZ'
func (rwk *rwk_TZ) FmtMonthYearMedium(t time.Time) string {
