...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kln_KE'
func (kln *kln_KE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kln_KE'
func (kln *kln_KE) FmtMonthYearMedium(t time.Time) string {
