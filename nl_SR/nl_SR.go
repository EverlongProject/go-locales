...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nl_SR'
func (nl *nl_SR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nl_SR'
func (nl *nl_SR) FmtMonthYearMedium(t time.Time) string {
