...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nus_SS'
func (nus *nus_SS) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nus_SS'
func (nus *nus_SS) FmtMonthYearMedium(t time.Time) string {
