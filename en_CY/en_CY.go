...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_CY'
func (en *en_CY) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_CY'
func (en *en_CY) FmtMonthYearMedium(t time.Time) string {
