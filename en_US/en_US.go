...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_US'
func (en *en_US) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_US'
func (en *en_US) FmtMonthYearMedium(t time.Time) string {
