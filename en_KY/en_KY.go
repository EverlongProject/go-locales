...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_KY'
func (en *en_KY) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_KY'
func (en *en_KY) FmtMonthYearMedium(t time.Time) string {
