...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bn_BD'
func (bn *bn_BD) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bn_BD'
func (bn *bn_BD) FmtMonthYearMedium(t time.Time) string {
