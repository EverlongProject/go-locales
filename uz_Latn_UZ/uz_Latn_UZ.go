...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'uz_Latn_UZ'
func (uz *uz_Latn_UZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'uz_Latn_UZ'
func (uz *uz_Latn_UZ) FmtMonthYearMedium(t time.Time) string {
