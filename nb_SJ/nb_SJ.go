...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nb_SJ'
func (nb *nb_SJ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nb_SJ'
func (nb *nb_SJ) FmtMonthYearMedium(t time.Time) string {
