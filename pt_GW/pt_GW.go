...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pt_GW'
func (pt *pt_GW) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pt_GW'
func (pt *pt_GW) FmtMonthYearMedium(t time.Time) string {
