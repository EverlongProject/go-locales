...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_BS'
func (en *en_BS) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_BS'
func (en *en_BS) FmtMonthYearMedium(t time.Time) string {
