...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lb'
func (lb *lb) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lb'
func (lb *lb) FmtMonthYearMedium(t time.Time) string {
