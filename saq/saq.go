...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'saq'
func (saq *saq) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'saq'
func (saq *saq) FmtMonthYearMedium(t time.Time) string {
