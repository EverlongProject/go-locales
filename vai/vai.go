...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'vai'
func (vai *vai) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'vai'
func (vai *vai) FmtMonthYearMedium(t time.Time) string {
