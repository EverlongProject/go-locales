...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_MG'
func (fr *fr_MG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_MG'
func (fr *fr_MG) FmtMonthYearMedium(t time.Time) string {
