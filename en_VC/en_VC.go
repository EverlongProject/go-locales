...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_VC'
func (en *en_VC) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_VC'
func (en *en_VC) FmtMonthYearMedium(t time.Time) string {
