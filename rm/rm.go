...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'rm'
func (rm *rm) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'rm'
func (rm *rm) FmtMonthYearMedium(t time.Time) string {
