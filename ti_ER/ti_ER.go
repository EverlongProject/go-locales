...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ti_ER'
func (ti *ti_ER) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ti_ER'
func (ti *ti_ER) FmtMonthYearMedium(t time.Time) string {
