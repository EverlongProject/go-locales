...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pt_TL'
func (pt *pt_TL) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pt_TL'
func (pt *pt_TL) FmtMonthYearMedium(t time.Time) string {
