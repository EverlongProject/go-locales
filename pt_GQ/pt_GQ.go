...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pt_GQ'
func (pt *pt_GQ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pt_GQ'
func (pt *pt_GQ) FmtMonthYearMedium(t time.Time) string {
