...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'seh_MZ'
func (seh *seh_MZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'seh_MZ'
func (seh *seh_MZ) FmtMonthYearMedium(t time.Time) string {
