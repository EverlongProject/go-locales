...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sq_AL'
func (sq *sq_AL) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sq_AL'
func (sq *sq_AL) FmtMonthYearMedium(t time.Time) string {
