...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'twq'
func (twq *twq) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'twq'
func (twq *twq) FmtMonthYearMedium(t time.Time) string {
