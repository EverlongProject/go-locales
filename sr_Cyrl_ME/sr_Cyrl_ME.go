...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sr_Cyrl_ME'
func (sr *sr_Cyrl_ME) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sr_Cyrl_ME'
func (sr *sr_Cyrl_ME) FmtMonthYearMedium(t time.Time) string {
