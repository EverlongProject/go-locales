...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ce'
func (ce *ce) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ce'
func (ce *ce) FmtMonthYearMedium(t time.Time) string {
