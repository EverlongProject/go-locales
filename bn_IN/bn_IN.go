...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bn_IN'
func (bn *bn_IN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bn_IN'
func (bn *bn_IN) FmtMonthYearMedium(t time.Time) string {
