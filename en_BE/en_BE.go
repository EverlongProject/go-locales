...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_BE'
func (en *en_BE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_BE'
func (en *en_BE) FmtMonthYearMedium(t time.Time) string {
