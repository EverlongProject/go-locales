...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bs_Cyrl'
func (bs *bs_Cyrl) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bs_Cyrl'
func (bs *bs_Cyrl) FmtMonthYearMedium(t time.Time) string {
