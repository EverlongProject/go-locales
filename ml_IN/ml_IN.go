...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ml_IN'
func (ml *ml_IN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ml_IN'
func (ml *ml_IN) FmtMonthYearMedium(t time.Time) string {
