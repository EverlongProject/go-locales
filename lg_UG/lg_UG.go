...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lg_UG'
func (lg *lg_UG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lg_UG'
func (lg *lg_UG) FmtMonthYearMedium(t time.Time) string {
