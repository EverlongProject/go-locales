...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'de_AT'
func (de *de_AT) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'de_AT'
func (de *de_AT) FmtMonthYearMedium(t time.Time) string {
