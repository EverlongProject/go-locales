...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bn'
func (bn *bn) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bn'
func (bn *bn) FmtMonthYearMedium(t time.Time) string {
