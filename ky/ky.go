...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ky'
func (ky *ky) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ky'
func (ky *ky) FmtMonthYearMedium(t time.Time) string {
