...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ur_PK'
func (ur *ur_PK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ur_PK'
func (ur *ur_PK) FmtMonthYearMedium(t time.Time) string {
