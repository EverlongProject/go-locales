...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fo'
func (fo *fo) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fo'
func (fo *fo) FmtMonthYearMedium(t time.Time) string {
