...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sw'
func (sw *sw) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sw'
func (sw *sw) FmtMonthYearMedium(t time.Time) string {
