...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'tr'
func (tr *tr) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'tr'
func (tr *tr) FmtMonthYearMedium(t time.Time) string {
