...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_KI'
func (en *en_KI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_KI'
func (en *en_KI) FmtMonthYearMedium(t time.Time) string {
