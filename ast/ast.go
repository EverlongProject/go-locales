...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ast'
func (ast *ast) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ast'
func (ast *ast) FmtMonthYearMedium(t time.Time) string {
