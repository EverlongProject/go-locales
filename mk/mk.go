...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mk'
func (mk *mk) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mk'
func (mk *mk) FmtMonthYearMedium(t time.Time) string {
