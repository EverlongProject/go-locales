...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_CH'
func (en *en_CH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_CH'
func (en *en_CH) FmtMonthYearMedium(t time.Time) string {
