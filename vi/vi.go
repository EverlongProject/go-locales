...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'vi'
func (vi *vi) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'vi'
func (vi *vi) FmtMonthYearMedium(t time.Time) string {
