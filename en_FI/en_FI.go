...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_FI'
func (en *en_FI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_FI'
func (en *en_FI) FmtMonthYearMedium(t time.Time) string {
