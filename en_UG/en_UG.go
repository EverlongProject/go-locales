...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_UG'
func (en *en_UG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_UG'
func (en *en_UG) FmtMonthYearMedium(t time.Time) string {
