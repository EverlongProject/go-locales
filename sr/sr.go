...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sr'
func (sr *sr) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sr'
func (sr *sr) FmtMonthYearMedium(t time.Time) string {
