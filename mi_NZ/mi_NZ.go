...
func New() locales.Translator {
	return &mi_NZ{
		...
		timezones:              map[string]string{"ADT": "Wā Awatea Ranatiki", "AST": "Wā Arowhānui Ranatiki", "CDT": "Wā Awatea Waenga", "CST": "Wā Arowhānui Waenga", "EDT": "Wā Awatea Rāwhiti", "EST": "Wā Arowhānui Rāwhiti", "GMT": "Wā Toharite Greenwich", "MDT": "Wā Awatea Maunga", "MESZ": "Wā Raumati Uropi Waenga", "MEZ": "Wā Arowhānui Uropi Waenga", "MST": "Wā Arowhānui Maunga", "OESZ": "Wā Raumati Uropi Rāwhiti", "OEZ": "Wā Arowhānui Uropi Rāwhiti", "PDT": "Wā Awatea Kiwa", "PST": "Wā Arowhānui Kiwa", "WESZ": "Wā Raumati Uropi Uru", "WEZ": "Wā Arowhānui Uropi Uru"},
	}
}
...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mi_NZ'
func (mi *mi_NZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mi_NZ'
func (mi *mi_NZ) FmtMonthYearMedium(t time.Time) string {
