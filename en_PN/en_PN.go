...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_PN'
func (en *en_PN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_PN'
func (en *en_PN) FmtMonthYearMedium(t time.Time) string {
