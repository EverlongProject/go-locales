...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sq_XK'
func (sq *sq_XK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sq_XK'
func (sq *sq_XK) FmtMonthYearMedium(t time.Time) string {
