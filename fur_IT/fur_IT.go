...
func New() locales.Translator {
	return &fur_IT{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"MESZ": "Ore estive de Europe centrâl", "MEZ": "Ore standard de Europe centrâl", "OESZ": "Ore estive de Europe orientâl", "OEZ": "Ore standard de Europe orientâl", "WESZ": "Ore estive de Europe ocidentâl", "WEZ": "Ore standard de Europe ocidentâl"},
	}
}
...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fur_IT'
func (fur *fur_IT) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fur_IT'
func (fur *fur_IT) FmtMonthYearMedium(t time.Time) string {
