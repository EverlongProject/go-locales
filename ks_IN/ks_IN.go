...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ks_IN'
func (ks *ks_IN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ks_IN'
func (ks *ks_IN) FmtMonthYearMedium(t time.Time) string {
