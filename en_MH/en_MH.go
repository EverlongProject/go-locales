...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_MH'
func (en *en_MH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_MH'
func (en *en_MH) FmtMonthYearMedium(t time.Time) string {
