...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sg_CF'
func (sg *sg_CF) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sg_CF'
func (sg *sg_CF) FmtMonthYearMedium(t time.Time) string {
