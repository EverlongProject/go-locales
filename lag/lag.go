...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lag'
func (lag *lag) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lag'
func (lag *lag) FmtMonthYearMedium(t time.Time) string {
