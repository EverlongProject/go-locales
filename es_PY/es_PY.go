...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_PY'
func (es *es_PY) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_PY'
func (es *es_PY) FmtMonthYearMedium(t time.Time) string {
