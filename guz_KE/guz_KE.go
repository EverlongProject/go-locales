...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'guz_KE'
func (guz *guz_KE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'guz_KE'
func (guz *guz_KE) FmtMonthYearMedium(t time.Time) string {
