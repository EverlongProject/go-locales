...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_CL'
func (es *es_CL) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_CL'
func (es *es_CL) FmtMonthYearMedium(t time.Time) string {
