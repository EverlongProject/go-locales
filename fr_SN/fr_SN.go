...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_SN'
func (fr *fr_SN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_SN'
func (fr *fr_SN) FmtMonthYearMedium(t time.Time) string {
