...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_BL'
func (fr *fr_BL) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_BL'
func (fr *fr_BL) FmtMonthYearMedium(t time.Time) string {
