...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sr_Cyrl_BA'
func (sr *sr_Cyrl_BA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sr_Cyrl_BA'
func (sr *sr_Cyrl_BA) FmtMonthYearMedium(t time.Time) string {
