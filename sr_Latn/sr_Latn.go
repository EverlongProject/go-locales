...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sr_Latn'
func (sr *sr_Latn) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sr_Latn'
func (sr *sr_Latn) FmtMonthYearMedium(t time.Time) string {
