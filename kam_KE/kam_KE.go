...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kam_KE'
func (kam *kam_KE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kam_KE'
func (kam *kam_KE) FmtMonthYearMedium(t time.Time) string {
