...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_CI'
func (fr *fr_CI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_CI'
func (fr *fr_CI) FmtMonthYearMedium(t time.Time) string {
