...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_GH'
func (en *en_GH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_GH'
func (en *en_GH) FmtMonthYearMedium(t time.Time) string {
