...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fo_DK'
func (fo *fo_DK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fo_DK'
func (fo *fo_DK) FmtMonthYearMedium(t time.Time) string {
