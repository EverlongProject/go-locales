...
func New() locales.Translator {
	return &ia_001{
		...
		timezones:              map[string]string{"ADT": "hora estive atlantic", "AKDT": "hora estive de Alaska", "AKST": "hora normal de Alaska", "AST": "hora normal atlantic", "CDT": "hora estive central", "CST": "hora normal central", "EDT": "hora estive del est", "EST": "hora normal del est", "GMT": "hora medie de Greenwich", "HADT": "hora estive de Hawaii-Aleutianas", "HAST": "hora normal de Hawaii-Aleutianas", "HAT": "hora estive de Terranova", "HECU": "hora estive de Cuba", "HEEG": "hora estive de Groenlandia oriental", "HENOMX": "hora estive del nordwest de Mexico", "HEOG": "hora estive de Groenlandia occidental", "HEPM": "hora estive de Saint-Pierre e Miquelon", "HEPMX": "hora estive del Pacifico mexican", "HNCU": "hora normal de Cuba", "HNEG": "hora normal de Groenlandia oriental", "HNNOMX": "hora normal del nordwest de Mexico", "HNOG": "hora normal de Groenlandia occidental", "HNPM": "hora normal de Saint-Pierre e Miquelon", "HNPMX": "hora normal del Pacifico mexican", "HNT": "hora normal de Terranova", "MDT": "hora estive del montanias", "MESZ": "hora estive de Europa central", "MEZ": "hora normal de Europa central", "MST": "hora normal del montanias", "OESZ": "hora estive de Europa oriental", "OEZ": "hora normal de Europa oriental", "PDT": "hora estive pacific", "PST": "hora normal pacific", "WESZ": "hora estive de Europa occidental", "WEZ": "hora normal de Europa occidental", "∅∅∅": "hora estive del Azores"},
	}
}
...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ia_001'
func (ia *ia_001) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ia_001'
func (ia *ia_001) FmtMonthYearMedium(t time.Time) string {
