...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mas'
func (mas *mas) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mas'
func (mas *mas) FmtMonthYearMedium(t time.Time) string {
