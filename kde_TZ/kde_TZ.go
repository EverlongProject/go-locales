...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kde_TZ'
func (kde *kde_TZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kde_TZ'
func (kde *kde_TZ) FmtMonthYearMedium(t time.Time) string {
