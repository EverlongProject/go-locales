...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pt_BR'
func (pt *pt_BR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pt_BR'
func (pt *pt_BR) FmtMonthYearMedium(t time.Time) string {
