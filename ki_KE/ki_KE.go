...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ki_KE'
func (ki *ki_KE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ki_KE'
func (ki *ki_KE) FmtMonthYearMedium(t time.Time) string {
