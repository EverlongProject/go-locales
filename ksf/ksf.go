...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ksf'
func (ksf *ksf) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ksf'
func (ksf *ksf) FmtMonthYearMedium(t time.Time) string {
