...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'cgg_UG'
func (cgg *cgg_UG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'cgg_UG'
func (cgg *cgg_UG) FmtMonthYearMedium(t time.Time) string {
