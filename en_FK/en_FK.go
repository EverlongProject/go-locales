...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_FK'
func (en *en_FK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_FK'
func (en *en_FK) FmtMonthYearMedium(t time.Time) string {
