...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ccp'
func (ccp *ccp) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ccp'
func (ccp *ccp) FmtMonthYearMedium(t time.Time) string {
