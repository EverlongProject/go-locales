...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'tr_CY'
func (tr *tr_CY) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'tr_CY'
func (tr *tr_CY) FmtMonthYearMedium(t time.Time) string {
