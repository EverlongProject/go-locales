...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pt_ST'
func (pt *pt_ST) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pt_ST'
func (pt *pt_ST) FmtMonthYearMedium(t time.Time) string {
