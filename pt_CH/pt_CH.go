...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pt_CH'
func (pt *pt_CH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pt_CH'
func (pt *pt_CH) FmtMonthYearMedium(t time.Time) string {
