...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ja'
func (ja *ja) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ja'
func (ja *ja) FmtMonthYearMedium(t time.Time) string {
