...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_DZ'
func (fr *fr_DZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_DZ'
func (fr *fr_DZ) FmtMonthYearMedium(t time.Time) string {
