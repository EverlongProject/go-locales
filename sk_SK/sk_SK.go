...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sk_SK'
func (sk *sk_SK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sk_SK'
func (sk *sk_SK) FmtMonthYearMedium(t time.Time) string {
