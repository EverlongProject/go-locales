...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_TD'
func (ar *ar_TD) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_TD'
func (ar *ar_TD) FmtMonthYearMedium(t time.Time) string {
