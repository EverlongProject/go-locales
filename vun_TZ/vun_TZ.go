...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'vun_TZ'
func (vun *vun_TZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'vun_TZ'
func (vun *vun_TZ) FmtMonthYearMedium(t time.Time) string {
