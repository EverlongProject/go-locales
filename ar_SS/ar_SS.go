...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_SS'
func (ar *ar_SS) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_SS'
func (ar *ar_SS) FmtMonthYearMedium(t time.Time) string {
