...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ro_MD'
func (ro *ro_MD) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ro_MD'
func (ro *ro_MD) FmtMonthYearMedium(t time.Time) string {
