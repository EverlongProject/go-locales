...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_CH'
func (fr *fr_CH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_CH'
func (fr *fr_CH) FmtMonthYearMedium(t time.Time) string {
