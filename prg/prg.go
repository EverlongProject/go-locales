...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'prg'
func (prg *prg) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'prg'
func (prg *prg) FmtMonthYearMedium(t time.Time) string {
