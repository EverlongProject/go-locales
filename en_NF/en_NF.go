...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_NF'
func (en *en_NF) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_NF'
func (en *en_NF) FmtMonthYearMedium(t time.Time) string {
