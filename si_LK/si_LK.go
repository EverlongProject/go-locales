...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'si_LK'
func (si *si_LK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'si_LK'
func (si *si_LK) FmtMonthYearMedium(t time.Time) string {
