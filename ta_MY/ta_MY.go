...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ta_MY'
func (ta *ta_MY) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ta_MY'
func (ta *ta_MY) FmtMonthYearMedium(t time.Time) string {
