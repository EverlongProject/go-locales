...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'asa_TZ'
func (asa *asa_TZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'asa_TZ'
func (asa *asa_TZ) FmtMonthYearMedium(t time.Time) string {
