...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sah'
func (sah *sah) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sah'
func (sah *sah) FmtMonthYearMedium(t time.Time) string {
