...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_AS'
func (en *en_AS) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_AS'
func (en *en_AS) FmtMonthYearMedium(t time.Time) string {
