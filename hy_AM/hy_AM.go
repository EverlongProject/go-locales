...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'hy_AM'
func (hy *hy_AM) FmtMonthDayMedium(t time.Time) string {
	...
	b = append(b, []byte{0x20}...)
	b = append(b, hy.monthsAbbreviated[t.Month()]...)
	b = append(b, []byte{0xd5, 0xa9}...)

	return string(b)
}

// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'hy_AM'
func (hy *hy_AM) FmtMonthYearMedium(t time.Time) string {
