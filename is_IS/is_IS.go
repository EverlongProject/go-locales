...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'is_IS'
func (is *is_IS) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'is_IS'
func (is *is_IS) FmtMonthYearMedium(t time.Time) string {
