...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ff_Latn_NE'
func (ff *ff_Latn_NE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ff_Latn_NE'
func (ff *ff_Latn_NE) FmtMonthYearMedium(t time.Time) string {
