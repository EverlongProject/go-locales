...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_PW'
func (en *en_PW) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_PW'
func (en *en_PW) FmtMonthYearMedium(t time.Time) string {
