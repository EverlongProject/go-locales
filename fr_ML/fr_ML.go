...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_ML'
func (fr *fr_ML) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_ML'
func (fr *fr_ML) FmtMonthYearMedium(t time.Time) string {
