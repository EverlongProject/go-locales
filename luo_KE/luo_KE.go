...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'luo_KE'
func (luo *luo_KE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'luo_KE'
func (luo *luo_KE) FmtMonthYearMedium(t time.Time) string {
