...
func New() locales.Translator {
	return &se_SE{
		...
		timezones:              map[string]string{"GMT": "Greenwich gaskka áigi", "MESZ": "gaska-Eurohpá geassiáigi", "MEZ": "gaska-Eurohpá dábálašáigi", "OESZ": "nuorti-Eurohpá geassiáigi", "OEZ": "nuorti-Eurohpá dábálašáigi", "WESZ": "oarje-Eurohpá geassiáigi", "WEZ": "oarje-Eurohpá dábálašáigi"},
	}
}
...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'se_SE'
func (se *se_SE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'se_SE'
func (se *se_SE) FmtMonthYearMedium(t time.Time) string {
