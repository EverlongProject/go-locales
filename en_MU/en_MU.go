...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_MU'
func (en *en_MU) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_MU'
func (en *en_MU) FmtMonthYearMedium(t time.Time) string {
