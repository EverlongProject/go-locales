...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pa_Guru'
func (pa *pa_Guru) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pa_Guru'
func (pa *pa_Guru) FmtMonthYearMedium(t time.Time) string {
