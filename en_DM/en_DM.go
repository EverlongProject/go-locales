...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_DM'
func (en *en_DM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_DM'
func (en *en_DM) FmtMonthYearMedium(t time.Time) string {
