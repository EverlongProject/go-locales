...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ewo'
func (ewo *ewo) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ewo'
func (ewo *ewo) FmtMonthYearMedium(t time.Time) string {
