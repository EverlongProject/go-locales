...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'hi'
func (hi *hi) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'hi'
func (hi *hi) FmtMonthYearMedium(t time.Time) string {
