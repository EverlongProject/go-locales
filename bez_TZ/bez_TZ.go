...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bez_TZ'
func (bez *bez_TZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bez_TZ'
func (bez *bez_TZ) FmtMonthYearMedium(t time.Time) string {
