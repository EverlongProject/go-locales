...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_VU'
func (en *en_VU) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_VU'
func (en *en_VU) FmtMonthYearMedium(t time.Time) string {
