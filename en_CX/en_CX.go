...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_CX'
func (en *en_CX) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_CX'
func (en *en_CX) FmtMonthYearMedium(t time.Time) string {
