...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_GP'
func (fr *fr_GP) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_GP'
func (fr *fr_GP) FmtMonthYearMedium(t time.Time) string {
