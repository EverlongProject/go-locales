...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'he_IL'
func (he *he_IL) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'he_IL'
func (he *he_IL) FmtMonthYearMedium(t time.Time) string {
