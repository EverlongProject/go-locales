...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ln_AO'
func (ln *ln_AO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ln_AO'
func (ln *ln_AO) FmtMonthYearMedium(t time.Time) string {
