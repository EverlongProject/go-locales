...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'af'
func (af *af) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'af'
func (af *af) FmtMonthYearMedium(t time.Time) string {
