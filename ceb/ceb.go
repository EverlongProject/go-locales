...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ceb'
func (ceb *ceb) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ceb'
func (ceb *ceb) FmtMonthYearMedium(t time.Time) string {
