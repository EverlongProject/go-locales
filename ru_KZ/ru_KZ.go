...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ru_KZ'
func (ru *ru_KZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ru_KZ'
func (ru *ru_KZ) FmtMonthYearMedium(t time.Time) string {
