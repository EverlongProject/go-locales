...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_ES'
func (es *es_ES) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_ES'
func (es *es_ES) FmtMonthYearMedium(t time.Time) string {
