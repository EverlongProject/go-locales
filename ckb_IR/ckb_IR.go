...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ckb_IR'
func (ckb *ckb_IR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ckb_IR'
func (ckb *ckb_IR) FmtMonthYearMedium(t time.Time) string {
