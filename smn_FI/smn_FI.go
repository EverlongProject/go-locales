...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'smn_FI'
func (smn *smn_FI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'smn_FI'
func (smn *smn_FI) FmtMonthYearMedium(t time.Time) string {
