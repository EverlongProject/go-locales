...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'af_ZA'
func (af *af_ZA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'af_ZA'
func (af *af_ZA) FmtMonthYearMedium(t time.Time) string {
