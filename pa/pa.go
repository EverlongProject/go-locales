...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pa'
func (pa *pa) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pa'
func (pa *pa) FmtMonthYearMedium(t time.Time) string {
