...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ru_BY'
func (ru *ru_BY) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ru_BY'
func (ru *ru_BY) FmtMonthYearMedium(t time.Time) string {
