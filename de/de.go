...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'de'
func (de *de) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'de'
func (de *de) FmtMonthYearMedium(t time.Time) string {
