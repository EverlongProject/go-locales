...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_SD'
func (ar *ar_SD) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_SD'
func (ar *ar_SD) FmtMonthYearMedium(t time.Time) string {
