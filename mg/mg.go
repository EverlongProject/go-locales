...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mg'
func (mg *mg) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mg'
func (mg *mg) FmtMonthYearMedium(t time.Time) string {
