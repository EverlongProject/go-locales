...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pl_PL'
func (pl *pl_PL) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pl_PL'
func (pl *pl_PL) FmtMonthYearMedium(t time.Time) string {
