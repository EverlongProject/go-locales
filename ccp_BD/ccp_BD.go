...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ccp_BD'
func (ccp *ccp_BD) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ccp_BD'
func (ccp *ccp_BD) FmtMonthYearMedium(t time.Time) string {
