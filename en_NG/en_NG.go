...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_NG'
func (en *en_NG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_NG'
func (en *en_NG) FmtMonthYearMedium(t time.Time) string {
