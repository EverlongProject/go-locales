...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ga'
func (ga *ga) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ga'
func (ga *ga) FmtMonthYearMedium(t time.Time) string {
