...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_MA'
func (ar *ar_MA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_MA'
func (ar *ar_MA) FmtMonthYearMedium(t time.Time) string {
