...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ln_CD'
func (ln *ln_CD) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ln_CD'
func (ln *ln_CD) FmtMonthYearMedium(t time.Time) string {
