...
func New() locales.Translator {
	return &ksh_DE{
		...
		timezones:              map[string]string{"CAT": "Zentraal-Affrekaanesche Zigg", "EAT": "Oß-Affrekaanesche Zigg", "GMT": "Greenwich sing Standat-Zick", "MESZ": "Meddel-Europpa sing Summerzick", "MEZ": "Meddel-Europpa sing jewöhnlijje Zick", "OESZ": "Oß-Europpa sing Summerzick", "OEZ": "Oß-Europpa sing jewöhnlijje Zick", "SAST": "Söd-Affrekaanesche Zigg", "WAST": "Wäß-Affrekaanesche Sommerzigg", "WAT": "Jewöhnlijje Wäß-Affrekaanesche Zigg", "WESZ": "Weß-Europpa sing Summerzick", "WEZ": "Weß-Europpa sing jewöhnlijje Zick", "∅∅∅": "de Azore ier Summerzick"},
	}
}
...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ksh_DE'
func (ksh *ksh_DE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ksh_DE'
func (ksh *ksh_DE) FmtMonthYearMedium(t time.Time) string {
