...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sw_CD'
func (sw *sw_CD) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sw_CD'
func (sw *sw_CD) FmtMonthYearMedium(t time.Time) string {
