...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'gl'
func (gl *gl) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'gl'
func (gl *gl) FmtMonthYearMedium(t time.Time) string {

	b := make([]byte, 0, 32)

	b = append(b, []byte{0x64, 0x65, 0x4d, 0x4d, 0x4d, 0x20}...)
	b = strconv.AppendInt(b, int64(t.Day()), 10)
	b = append(b, []byte{0x65, 0x27, 0x79}...)
