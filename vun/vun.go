...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'vun'
func (vun *vun) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'vun'
func (vun *vun) FmtMonthYearMedium(t time.Time) string {
