...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'hy'
func (hy *hy) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'hy'
func (hy *hy) FmtMonthYearMedium(t time.Time) string {
