...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'gd_GB'
func (gd *gd_GB) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'gd_GB'
func (gd *gd_GB) FmtMonthYearMedium(t time.Time) string {
