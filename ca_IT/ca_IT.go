...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ca_IT'
func (ca *ca_IT) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ca_IT'
func (ca *ca_IT) FmtMonthYearMedium(t time.Time) string {
