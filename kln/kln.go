...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kln'
func (kln *kln) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kln'
func (kln *kln) FmtMonthYearMedium(t time.Time) string {
