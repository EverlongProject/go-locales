...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ro_RO'
func (ro *ro_RO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ro_RO'
func (ro *ro_RO) FmtMonthYearMedium(t time.Time) string {
