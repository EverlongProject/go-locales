...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lu'
func (lu *lu) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lu'
func (lu *lu) FmtMonthYearMedium(t time.Time) string {
