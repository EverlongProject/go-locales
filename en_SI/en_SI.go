...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_SI'
func (en *en_SI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_SI'
func (en *en_SI) FmtMonthYearMedium(t time.Time) string {
