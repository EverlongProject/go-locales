...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ga_IE'
func (ga *ga_IE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ga_IE'
func (ga *ga_IE) FmtMonthYearMedium(t time.Time) string {
