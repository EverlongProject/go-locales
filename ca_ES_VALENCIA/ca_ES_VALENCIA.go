...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ca_ES_VALENCIA'
func (ca *ca_ES_VALENCIA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ca_ES_VALENCIA'
func (ca *ca_ES_VALENCIA) FmtMonthYearMedium(t time.Time) string {
