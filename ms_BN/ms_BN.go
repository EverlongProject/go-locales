...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ms_BN'
func (ms *ms_BN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ms_BN'
func (ms *ms_BN) FmtMonthYearMedium(t time.Time) string {
