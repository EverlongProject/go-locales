...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nnh'
func (nnh *nnh) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nnh'
func (nnh *nnh) FmtMonthYearMedium(t time.Time) string {
