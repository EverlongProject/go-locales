...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sbp_TZ'
func (sbp *sbp_TZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sbp_TZ'
func (sbp *sbp_TZ) FmtMonthYearMedium(t time.Time) string {
