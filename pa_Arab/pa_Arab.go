...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pa_Arab'
func (pa *pa_Arab) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pa_Arab'
func (pa *pa_Arab) FmtMonthYearMedium(t time.Time) string {
