...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_CD'
func (fr *fr_CD) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_CD'
func (fr *fr_CD) FmtMonthYearMedium(t time.Time) string {
