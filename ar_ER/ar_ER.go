...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_ER'
func (ar *ar_ER) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_ER'
func (ar *ar_ER) FmtMonthYearMedium(t time.Time) string {
