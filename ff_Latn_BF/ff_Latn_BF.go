...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ff_Latn_BF'
func (ff *ff_Latn_BF) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ff_Latn_BF'
func (ff *ff_Latn_BF) FmtMonthYearMedium(t time.Time) string {
