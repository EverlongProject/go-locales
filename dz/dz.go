...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'dz'
func (dz *dz) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'dz'
func (dz *dz) FmtMonthYearMedium(t time.Time) string {
