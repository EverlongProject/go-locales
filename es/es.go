...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es'
func (es *es) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es'
func (es *es) FmtMonthYearMedium(t time.Time) string {
