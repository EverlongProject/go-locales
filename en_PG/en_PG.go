...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_PG'
func (en *en_PG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_PG'
func (en *en_PG) FmtMonthYearMedium(t time.Time) string {
