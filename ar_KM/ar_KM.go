...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_KM'
func (ar *ar_KM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_KM'
func (ar *ar_KM) FmtMonthYearMedium(t time.Time) string {
