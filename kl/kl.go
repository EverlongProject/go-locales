...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kl'
func (kl *kl) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kl'
func (kl *kl) FmtMonthYearMedium(t time.Time) string {
