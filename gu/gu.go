...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'gu'
func (gu *gu) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'gu'
func (gu *gu) FmtMonthYearMedium(t time.Time) string {
