...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pt'
func (pt *pt) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pt'
func (pt *pt) FmtMonthYearMedium(t time.Time) string {
