...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bg'
func (bg *bg) FmtMonthDayMedium(t time.Time) string {
	...
	b = append(b, []byte{0x2e, 0xd0, 0xb3}...)

	return string(b)
}

// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bg'
func (bg *bg) FmtMonthYearMedium(t time.Time) string {
