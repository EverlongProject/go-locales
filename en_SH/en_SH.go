...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_SH'
func (en *en_SH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_SH'
func (en *en_SH) FmtMonthYearMedium(t time.Time) string {
