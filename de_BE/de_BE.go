...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'de_BE'
func (de *de_BE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'de_BE'
func (de *de_BE) FmtMonthYearMedium(t time.Time) string {
