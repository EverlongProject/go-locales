...
func New() locales.Translator {
	return &kea_CV{
		...
		timezones:              map[string]string{"ACDT": "Ora di Veron di Austrália Sentral", "ACST": "Ora Padron di Austrália Sentral", "ACWDT": "Ora di Veron di Austrália Sentru-Osidental", "ACWST": "Ora Padron di Austrália Sentru-Osidental", "ADT": "Ora di Veron di Atlántiku", "AEDT": "Ora di Veron di Austrália Oriental", "AEST": "Ora Padron di Austrália Oriental", "AKDT": "Ora di Veron di Alaska", "AKST": "Ora Padron di Alaska", "AST": "Ora Padron di Atlántiku", "AWDT": "Ora di Veron di Austrália Osidental", "AWST": "Ora Padron di Austrália Osidental", "CAT": "Ora di Áfrika Sentral", "CDT": "Ora di Veron Sentral", "CST": "Ora Padron Sentral", "EAT": "Ora di Áfrika Oriental", "EDT": "Ora di Veron Oriental", "EST": "Ora Padron Oriental", "GMT": "Ora Médiu di Greenwich", "HECU": "Ora di Veron di Kuba", "HNCU": "Ora Padron di Kuba", "MDT": "Ora di Veron di Montanha", "MESZ": "Ora di Veron di Europa Sentral", "MEZ": "Ora Padron di Europa Sentral", "MST": "Ora Padron di Montanha", "OESZ": "Ora di Veron di Europa Oriental", "OEZ": "Ora Padron di Europa Oriental", "PDT": "Ora di Veron di Pasífiku", "PST": "Ora Padron di Pasífiku", "SAST": "Ora di Sul di Áfrika", "WAST": "Ora di Veron di Áfrika Osidental", "WAT": "Ora Padron di Áfrika Osidental", "WESZ": "Ora di Veron di Europa Osidental", "WEZ": "Ora Padron di Europa Osidental"},
	}
}
...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kea_CV'
func (kea *kea_CV) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kea_CV'
func (kea *kea_CV) FmtMonthYearMedium(t time.Time) string {
