...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_VI'
func (en *en_VI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_VI'
func (en *en_VI) FmtMonthYearMedium(t time.Time) string {
