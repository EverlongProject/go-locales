...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_GB'
func (en *en_GB) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_GB'
func (en *en_GB) FmtMonthYearMedium(t time.Time) string {
