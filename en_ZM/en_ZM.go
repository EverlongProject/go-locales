...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_ZM'
func (en *en_ZM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_ZM'
func (en *en_ZM) FmtMonthYearMedium(t time.Time) string {
