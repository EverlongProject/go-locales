...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_EG'
func (ar *ar_EG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_EG'
func (ar *ar_EG) FmtMonthYearMedium(t time.Time) string {
