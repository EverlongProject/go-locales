...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nnh_CM'
func (nnh *nnh_CM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nnh_CM'
func (nnh *nnh_CM) FmtMonthYearMedium(t time.Time) string {
