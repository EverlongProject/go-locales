...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mgh_MZ'
func (mgh *mgh_MZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mgh_MZ'
func (mgh *mgh_MZ) FmtMonthYearMedium(t time.Time) string {
