...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kl_GL'
func (kl *kl_GL) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kl_GL'
func (kl *kl_GL) FmtMonthYearMedium(t time.Time) string {
