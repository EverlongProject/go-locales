...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_QA'
func (ar *ar_QA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_QA'
func (ar *ar_QA) FmtMonthYearMedium(t time.Time) string {
