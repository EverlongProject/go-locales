...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_MQ'
func (fr *fr_MQ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_MQ'
func (fr *fr_MQ) FmtMonthYearMedium(t time.Time) string {
