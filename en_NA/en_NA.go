...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_NA'
func (en *en_NA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_NA'
func (en *en_NA) FmtMonthYearMedium(t time.Time) string {
