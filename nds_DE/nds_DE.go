...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nds_DE'
func (nds *nds_DE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nds_DE'
func (nds *nds_DE) FmtMonthYearMedium(t time.Time) string {
