...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'is'
func (is *is) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'is'
func (is *is) FmtMonthYearMedium(t time.Time) string {
