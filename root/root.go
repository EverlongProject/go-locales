...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'root'
func (root *root) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'root'
func (root *root) FmtMonthYearMedium(t time.Time) string {
