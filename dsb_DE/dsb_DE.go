...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'dsb_DE'
func (dsb *dsb_DE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'dsb_DE'
func (dsb *dsb_DE) FmtMonthYearMedium(t time.Time) string {
