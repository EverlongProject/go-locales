...
func New() locales.Translator {
	return &wo_SN{
		...
		timezones:              map[string]string{"ADT": "ADT (waxtu bëccëgu atlàntik)", "AST": "AST (waxtu estàndaaru penku)", "CDT": "CDT (waxtu bëccëgu sàntaraal", "CST": "CST (waxtu estàndaaru sàntaraal)", "EDT": "EDT (waxtu bëccëgu penku)", "EST": "EST (waxtu estàndaaru penku)", "GMT": "GMT (waxtu Greenwich)", "MDT": "MDT (waxtu bëccëgu tundu)", "MESZ": "CEST (waxtu ete wu ëroop sàntaraal)", "MEZ": "CEST (waxtu estàndaaru ëroop sàntaraal)", "MST": "MST (waxtu estàndaaru tundu)", "OESZ": "EEST (waxtu ete wu ëroop u penku)", "OEZ": "EEST (waxtu estàndaaru ëroop u penku)", "PDT": "PDT (waxtu bëccëgu pasifik)", "PST": "PST (waxtu estàndaaru pasifik)", "WESZ": "WEST (waxtu ete wu ëroop u sowwu-jant)", "WEZ": "WEST (waxtu estàndaaru ëroop u sowwu-jant)"},
	}
}
...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'wo_SN'
func (wo *wo_SN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'wo_SN'
func (wo *wo_SN) FmtMonthYearMedium(t time.Time) string {
