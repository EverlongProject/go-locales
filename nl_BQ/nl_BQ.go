...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nl_BQ'
func (nl *nl_BQ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nl_BQ'
func (nl *nl_BQ) FmtMonthYearMedium(t time.Time) string {
