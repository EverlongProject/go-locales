...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'or_IN'
func (or *or_IN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'or_IN'
func (or *or_IN) FmtMonthYearMedium(t time.Time) string {
