...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mt'
func (mt *mt) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mt'
func (mt *mt) FmtMonthYearMedium(t time.Time) string {
