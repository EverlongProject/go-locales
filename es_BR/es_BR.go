...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_BR'
func (es *es_BR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_BR'
func (es *es_BR) FmtMonthYearMedium(t time.Time) string {
