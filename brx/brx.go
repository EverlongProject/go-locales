...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'brx'
func (brx *brx) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'brx'
func (brx *brx) FmtMonthYearMedium(t time.Time) string {
