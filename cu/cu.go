...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'cu'
func (cu *cu) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'cu'
func (cu *cu) FmtMonthYearMedium(t time.Time) string {
