...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_GG'
func (en *en_GG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_GG'
func (en *en_GG) FmtMonthYearMedium(t time.Time) string {
