...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'wo'
func (wo *wo) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'wo'
func (wo *wo) FmtMonthYearMedium(t time.Time) string {
