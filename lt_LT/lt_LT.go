...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lt_LT'
func (lt *lt_LT) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lt_LT'
func (lt *lt_LT) FmtMonthYearMedium(t time.Time) string {
