...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mua_CM'
func (mua *mua_CM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mua_CM'
func (mua *mua_CM) FmtMonthYearMedium(t time.Time) string {
