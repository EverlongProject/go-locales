...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ki'
func (ki *ki) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ki'
func (ki *ki) FmtMonthYearMedium(t time.Time) string {
