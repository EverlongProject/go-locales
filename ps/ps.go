...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ps'
func (ps *ps) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ps'
func (ps *ps) FmtMonthYearMedium(t time.Time) string {
