...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ne_NP'
func (ne *ne_NP) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ne_NP'
func (ne *ne_NP) FmtMonthYearMedium(t time.Time) string {
