...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_SC'
func (fr *fr_SC) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_SC'
func (fr *fr_SC) FmtMonthYearMedium(t time.Time) string {
