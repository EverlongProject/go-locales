...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ps_PK'
func (ps *ps_PK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ps_PK'
func (ps *ps_PK) FmtMonthYearMedium(t time.Time) string {
