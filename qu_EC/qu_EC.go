...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'qu_EC'
func (qu *qu_EC) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'qu_EC'
func (qu *qu_EC) FmtMonthYearMedium(t time.Time) string {
