...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'uz_Cyrl'
func (uz *uz_Cyrl) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'uz_Cyrl'
func (uz *uz_Cyrl) FmtMonthYearMedium(t time.Time) string {
