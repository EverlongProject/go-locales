...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ast_ES'
func (ast *ast_ES) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ast_ES'
func (ast *ast_ES) FmtMonthYearMedium(t time.Time) string {
