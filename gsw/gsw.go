...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'gsw'
func (gsw *gsw) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'gsw'
func (gsw *gsw) FmtMonthYearMedium(t time.Time) string {
