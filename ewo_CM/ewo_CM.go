...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ewo_CM'
func (ewo *ewo_CM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ewo_CM'
func (ewo *ewo_CM) FmtMonthYearMedium(t time.Time) string {
