...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'so_DJ'
func (so *so_DJ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'so_DJ'
func (so *so_DJ) FmtMonthYearMedium(t time.Time) string {
