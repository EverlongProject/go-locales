...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fi_FI'
func (fi *fi_FI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fi_FI'
func (fi *fi_FI) FmtMonthYearMedium(t time.Time) string {
