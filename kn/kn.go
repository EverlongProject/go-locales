...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kn'
func (kn *kn) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kn'
func (kn *kn) FmtMonthYearMedium(t time.Time) string {
