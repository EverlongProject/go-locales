...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'so_KE'
func (so *so_KE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'so_KE'
func (so *so_KE) FmtMonthYearMedium(t time.Time) string {
