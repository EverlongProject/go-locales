...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ceb_PH'
func (ceb *ceb_PH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ceb_PH'
func (ceb *ceb_PH) FmtMonthYearMedium(t time.Time) string {
