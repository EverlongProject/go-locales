...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bas_CM'
func (bas *bas_CM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bas_CM'
func (bas *bas_CM) FmtMonthYearMedium(t time.Time) string {
