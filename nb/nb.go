...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nb'
func (nb *nb) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nb'
func (nb *nb) FmtMonthYearMedium(t time.Time) string {
