...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_IO'
func (en *en_IO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_IO'
func (en *en_IO) FmtMonthYearMedium(t time.Time) string {
