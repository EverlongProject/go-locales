...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sr_Latn_BA'
func (sr *sr_Latn_BA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sr_Latn_BA'
func (sr *sr_Latn_BA) FmtMonthYearMedium(t time.Time) string {
