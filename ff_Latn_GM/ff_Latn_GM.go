...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ff_Latn_GM'
func (ff *ff_Latn_GM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ff_Latn_GM'
func (ff *ff_Latn_GM) FmtMonthYearMedium(t time.Time) string {
