...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_HK'
func (en *en_HK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_HK'
func (en *en_HK) FmtMonthYearMedium(t time.Time) string {
