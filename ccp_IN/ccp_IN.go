...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ccp_IN'
func (ccp *ccp_IN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ccp_IN'
func (ccp *ccp_IN) FmtMonthYearMedium(t time.Time) string {
