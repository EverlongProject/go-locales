...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'dav'
func (dav *dav) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'dav'
func (dav *dav) FmtMonthYearMedium(t time.Time) string {
