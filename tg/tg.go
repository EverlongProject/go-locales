...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'tg'
func (tg *tg) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'tg'
func (tg *tg) FmtMonthYearMedium(t time.Time) string {
