...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'dyo_SN'
func (dyo *dyo_SN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'dyo_SN'
func (dyo *dyo_SN) FmtMonthYearMedium(t time.Time) string {
