...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'cs'
func (cs *cs) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'cs'
func (cs *cs) FmtMonthYearMedium(t time.Time) string {
