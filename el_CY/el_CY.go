...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'el_CY'
func (el *el_CY) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'el_CY'
func (el *el_CY) FmtMonthYearMedium(t time.Time) string {
