...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ur'
func (ur *ur) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ur'
func (ur *ur) FmtMonthYearMedium(t time.Time) string {
