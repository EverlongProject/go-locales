...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'eu_ES'
func (eu *eu_ES) FmtMonthDayMedium(t time.Time) string {

	b := make([]byte, 0, 32)

	b = append(b, []byte{0x65}...)
	b = append(b, []byte{0x6b, 0x6f}...)
	b = append(b, eu.monthsAbbreviated[t.Month()]...)
	b = append(b, []byte{0x20}...)
	b = strconv.AppendInt(b, int64(t.Day()), 10)
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'eu_ES'
func (eu *eu_ES) FmtMonthYearMedium(t time.Time) string {
