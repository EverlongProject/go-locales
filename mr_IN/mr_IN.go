...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mr_IN'
func (mr *mr_IN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mr_IN'
func (mr *mr_IN) FmtMonthYearMedium(t time.Time) string {
