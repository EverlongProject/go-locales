...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fi'
func (fi *fi) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fi'
func (fi *fi) FmtMonthYearMedium(t time.Time) string {
