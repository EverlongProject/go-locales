...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'chr_US'
func (chr *chr_US) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'chr_US'
func (chr *chr_US) FmtMonthYearMedium(t time.Time) string {
