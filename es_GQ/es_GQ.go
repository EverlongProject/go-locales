...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_GQ'
func (es *es_GQ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_GQ'
func (es *es_GQ) FmtMonthYearMedium(t time.Time) string {
