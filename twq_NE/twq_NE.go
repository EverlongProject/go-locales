...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'twq_NE'
func (twq *twq_NE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'twq_NE'
func (twq *twq_NE) FmtMonthYearMedium(t time.Time) string {
