...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_VE'
func (es *es_VE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_VE'
func (es *es_VE) FmtMonthYearMedium(t time.Time) string {
