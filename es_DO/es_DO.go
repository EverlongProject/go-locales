...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_DO'
func (es *es_DO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_DO'
func (es *es_DO) FmtMonthYearMedium(t time.Time) string {
