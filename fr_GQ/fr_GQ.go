...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_GQ'
func (fr *fr_GQ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_GQ'
func (fr *fr_GQ) FmtMonthYearMedium(t time.Time) string {
