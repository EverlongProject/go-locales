...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_DJ'
func (fr *fr_DJ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_DJ'
func (fr *fr_DJ) FmtMonthYearMedium(t time.Time) string {
