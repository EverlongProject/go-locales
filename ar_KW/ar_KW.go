...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_KW'
func (ar *ar_KW) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_KW'
func (ar *ar_KW) FmtMonthYearMedium(t time.Time) string {
