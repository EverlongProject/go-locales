...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'de_LI'
func (de *de_LI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'de_LI'
func (de *de_LI) FmtMonthYearMedium(t time.Time) string {
