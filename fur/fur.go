...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fur'
func (fur *fur) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fur'
func (fur *fur) FmtMonthYearMedium(t time.Time) string {
