...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lkt'
func (lkt *lkt) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lkt'
func (lkt *lkt) FmtMonthYearMedium(t time.Time) string {
