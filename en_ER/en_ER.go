...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_ER'
func (en *en_ER) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_ER'
func (en *en_ER) FmtMonthYearMedium(t time.Time) string {
