...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mgo_CM'
func (mgo *mgo_CM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mgo_CM'
func (mgo *mgo_CM) FmtMonthYearMedium(t time.Time) string {
