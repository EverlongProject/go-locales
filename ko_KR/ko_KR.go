...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ko_KR'
func (ko *ko_KR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ko_KR'
func (ko *ko_KR) FmtMonthYearMedium(t time.Time) string {
