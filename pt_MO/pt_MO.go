...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pt_MO'
func (pt *pt_MO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pt_MO'
func (pt *pt_MO) FmtMonthYearMedium(t time.Time) string {
