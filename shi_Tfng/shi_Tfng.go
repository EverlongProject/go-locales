...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'shi_Tfng'
func (shi *shi_Tfng) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'shi_Tfng'
func (shi *shi_Tfng) FmtMonthYearMedium(t time.Time) string {
