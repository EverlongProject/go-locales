...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_KE'
func (en *en_KE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_KE'
func (en *en_KE) FmtMonthYearMedium(t time.Time) string {
