...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ln_CG'
func (ln *ln_CG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ln_CG'
func (ln *ln_CG) FmtMonthYearMedium(t time.Time) string {
