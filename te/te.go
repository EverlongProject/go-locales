...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'te'
func (te *te) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'te'
func (te *te) FmtMonthYearMedium(t time.Time) string {
