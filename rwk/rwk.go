...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'rwk'
func (rwk *rwk) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'rwk'
func (rwk *rwk) FmtMonthYearMedium(t time.Time) string {
