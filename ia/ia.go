...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ia'
func (ia *ia) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ia'
func (ia *ia) FmtMonthYearMedium(t time.Time) string {
