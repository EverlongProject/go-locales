...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'teo'
func (teo *teo) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'teo'
func (teo *teo) FmtMonthYearMedium(t time.Time) string {
