...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_TG'
func (fr *fr_TG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_TG'
func (fr *fr_TG) FmtMonthYearMedium(t time.Time) string {
