...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pt_PT'
func (pt *pt_PT) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pt_PT'
func (pt *pt_PT) FmtMonthYearMedium(t time.Time) string {
