...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_SG'
func (en *en_SG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_SG'
func (en *en_SG) FmtMonthYearMedium(t time.Time) string {
