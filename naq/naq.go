...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'naq'
func (naq *naq) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'naq'
func (naq *naq) FmtMonthYearMedium(t time.Time) string {
