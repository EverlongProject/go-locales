...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_CC'
func (en *en_CC) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_CC'
func (en *en_CC) FmtMonthYearMedium(t time.Time) string {
