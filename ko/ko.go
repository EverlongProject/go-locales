...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ko'
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ko'
