...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_DE'
func (en *en_DE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_DE'
func (en *en_DE) FmtMonthYearMedium(t time.Time) string {
