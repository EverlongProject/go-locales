...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'to_TO'
func (to *to_TO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'to_TO'
func (to *to_TO) FmtMonthYearMedium(t time.Time) string {
