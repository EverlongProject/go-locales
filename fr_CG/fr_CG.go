...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_CG'
func (fr *fr_CG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_CG'
func (fr *fr_CG) FmtMonthYearMedium(t time.Time) string {
