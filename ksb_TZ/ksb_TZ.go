...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ksb_TZ'
func (ksb *ksb_TZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ksb_TZ'
func (ksb *ksb_TZ) FmtMonthYearMedium(t time.Time) string {
