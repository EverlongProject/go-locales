...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'zu'
func (zu *zu) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'zu'
func (zu *zu) FmtMonthYearMedium(t time.Time) string {
