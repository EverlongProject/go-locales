...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sd'
func (sd *sd) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sd'
func (sd *sd) FmtMonthYearMedium(t time.Time) string {
