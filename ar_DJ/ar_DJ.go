...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_DJ'
func (ar *ar_DJ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_DJ'
func (ar *ar_DJ) FmtMonthYearMedium(t time.Time) string {
