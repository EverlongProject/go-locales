...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nl'
func (nl *nl) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nl'
func (nl *nl) FmtMonthYearMedium(t time.Time) string {
