...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'it_CH'
func (it *it_CH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'it_CH'
func (it *it_CH) FmtMonthYearMedium(t time.Time) string {
