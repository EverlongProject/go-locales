...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sg'
func (sg *sg) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sg'
func (sg *sg) FmtMonthYearMedium(t time.Time) string {
