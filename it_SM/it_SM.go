...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'it_SM'
func (it *it_SM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'it_SM'
func (it *it_SM) FmtMonthYearMedium(t time.Time) string {
