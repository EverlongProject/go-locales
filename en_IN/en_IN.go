...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_IN'
func (en *en_IN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_IN'
func (en *en_IN) FmtMonthYearMedium(t time.Time) string {
