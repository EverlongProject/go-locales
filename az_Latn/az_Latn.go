...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'az_Latn'
func (az *az_Latn) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'az_Latn'
func (az *az_Latn) FmtMonthYearMedium(t time.Time) string {
