...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kde'
func (kde *kde) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kde'
func (kde *kde) FmtMonthYearMedium(t time.Time) string {
