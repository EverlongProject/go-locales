...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'teo_KE'
func (teo *teo_KE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'teo_KE'
func (teo *teo_KE) FmtMonthYearMedium(t time.Time) string {
