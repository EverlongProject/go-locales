...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sr_Cyrl'
func (sr *sr_Cyrl) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sr_Cyrl'
func (sr *sr_Cyrl) FmtMonthYearMedium(t time.Time) string {
