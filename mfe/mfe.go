...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mfe'
func (mfe *mfe) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mfe'
func (mfe *mfe) FmtMonthYearMedium(t time.Time) string {
