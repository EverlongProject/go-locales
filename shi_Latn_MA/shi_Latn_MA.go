...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'shi_Latn_MA'
func (shi *shi_Latn_MA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'shi_Latn_MA'
func (shi *shi_Latn_MA) FmtMonthYearMedium(t time.Time) string {
