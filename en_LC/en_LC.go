...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_LC'
func (en *en_LC) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_LC'
func (en *en_LC) FmtMonthYearMedium(t time.Time) string {
