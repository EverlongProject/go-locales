...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'tk_TM'
func (tk *tk_TM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'tk_TM'
func (tk *tk_TM) FmtMonthYearMedium(t time.Time) string {
