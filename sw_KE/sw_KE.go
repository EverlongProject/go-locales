...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sw_KE'
func (sw *sw_KE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sw_KE'
func (sw *sw_KE) FmtMonthYearMedium(t time.Time) string {
