...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_TN'
func (fr *fr_TN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_TN'
func (fr *fr_TN) FmtMonthYearMedium(t time.Time) string {
