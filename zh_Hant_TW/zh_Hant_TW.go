...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'zh_Hant_TW'
func (zh *zh_Hant_TW) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'zh_Hant_TW'
func (zh *zh_Hant_TW) FmtMonthYearMedium(t time.Time) string {
