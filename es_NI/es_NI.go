...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_NI'
func (es *es_NI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_NI'
func (es *es_NI) FmtMonthYearMedium(t time.Time) string {
