...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'de_DE'
func (de *de_DE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'de_DE'
func (de *de_DE) FmtMonthYearMedium(t time.Time) string {
