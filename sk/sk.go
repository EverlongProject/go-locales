...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sk'
func (sk *sk) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sk'
func (sk *sk) FmtMonthYearMedium(t time.Time) string {
