...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'or'
func (or *or) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'or'
func (or *or) FmtMonthYearMedium(t time.Time) string {
