...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'eo'
func (eo *eo) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'eo'
func (eo *eo) FmtMonthYearMedium(t time.Time) string {
