...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ne'
func (ne *ne) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ne'
func (ne *ne) FmtMonthYearMedium(t time.Time) string {
