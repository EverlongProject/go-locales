...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bez'
func (bez *bez) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bez'
func (bez *bez) FmtMonthYearMedium(t time.Time) string {
