...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lb_LU'
func (lb *lb_LU) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lb_LU'
func (lb *lb_LU) FmtMonthYearMedium(t time.Time) string {
