...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_CM'
func (fr *fr_CM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_CM'
func (fr *fr_CM) FmtMonthYearMedium(t time.Time) string {
