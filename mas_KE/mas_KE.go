...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mas_KE'
func (mas *mas_KE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mas_KE'
func (mas *mas_KE) FmtMonthYearMedium(t time.Time) string {
