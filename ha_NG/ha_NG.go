...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ha_NG'
func (ha *ha_NG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ha_NG'
func (ha *ha_NG) FmtMonthYearMedium(t time.Time) string {
