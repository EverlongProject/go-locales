...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'az_Cyrl'
func (az *az_Cyrl) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'az_Cyrl'
func (az *az_Cyrl) FmtMonthYearMedium(t time.Time) string {
