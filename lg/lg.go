...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lg'
func (lg *lg) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lg'
func (lg *lg) FmtMonthYearMedium(t time.Time) string {
