...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_WF'
func (fr *fr_WF) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_WF'
func (fr *fr_WF) FmtMonthYearMedium(t time.Time) string {
