...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_EH'
func (ar *ar_EH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_EH'
func (ar *ar_EH) FmtMonthYearMedium(t time.Time) string {
