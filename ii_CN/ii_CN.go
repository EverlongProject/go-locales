...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ii_CN'
func (ii *ii_CN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ii_CN'
func (ii *ii_CN) FmtMonthYearMedium(t time.Time) string {
