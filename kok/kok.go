...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kok'
func (kok *kok) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kok'
func (kok *kok) FmtMonthYearMedium(t time.Time) string {
