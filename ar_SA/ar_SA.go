...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_SA'
func (ar *ar_SA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_SA'
func (ar *ar_SA) FmtMonthYearMedium(t time.Time) string {
