...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_HN'
func (es *es_HN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_HN'
func (es *es_HN) FmtMonthYearMedium(t time.Time) string {
