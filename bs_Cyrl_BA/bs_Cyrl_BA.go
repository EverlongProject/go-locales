...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bs_Cyrl_BA'
func (bs *bs_Cyrl_BA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bs_Cyrl_BA'
func (bs *bs_Cyrl_BA) FmtMonthYearMedium(t time.Time) string {
