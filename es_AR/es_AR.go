...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_AR'
func (es *es_AR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_AR'
func (es *es_AR) FmtMonthYearMedium(t time.Time) string {
