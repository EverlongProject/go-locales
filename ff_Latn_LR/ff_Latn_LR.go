...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ff_Latn_LR'
func (ff *ff_Latn_LR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ff_Latn_LR'
func (ff *ff_Latn_LR) FmtMonthYearMedium(t time.Time) string {
