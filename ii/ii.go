...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ii'
func (ii *ii) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ii'
func (ii *ii) FmtMonthYearMedium(t time.Time) string {
