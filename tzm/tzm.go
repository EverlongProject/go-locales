...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'tzm'
func (tzm *tzm) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'tzm'
func (tzm *tzm) FmtMonthYearMedium(t time.Time) string {
