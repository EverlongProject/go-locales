...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_IC'
func (es *es_IC) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_IC'
func (es *es_IC) FmtMonthYearMedium(t time.Time) string {
