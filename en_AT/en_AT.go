...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_AT'
func (en *en_AT) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_AT'
func (en *en_AT) FmtMonthYearMedium(t time.Time) string {
