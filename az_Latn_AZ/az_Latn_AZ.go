...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'az_Latn_AZ'
func (az *az_Latn_AZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'az_Latn_AZ'
func (az *az_Latn_AZ) FmtMonthYearMedium(t time.Time) string {
