...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'shi_Latn'
func (shi *shi_Latn) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'shi_Latn'
func (shi *shi_Latn) FmtMonthYearMedium(t time.Time) string {
