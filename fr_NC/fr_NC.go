...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_NC'
func (fr *fr_NC) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_NC'
func (fr *fr_NC) FmtMonthYearMedium(t time.Time) string {
