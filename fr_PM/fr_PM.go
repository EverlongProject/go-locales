...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_PM'
func (fr *fr_PM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_PM'
func (fr *fr_PM) FmtMonthYearMedium(t time.Time) string {
