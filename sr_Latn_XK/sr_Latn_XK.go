...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sr_Latn_XK'
func (sr *sr_Latn_XK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sr_Latn_XK'
func (sr *sr_Latn_XK) FmtMonthYearMedium(t time.Time) string {
