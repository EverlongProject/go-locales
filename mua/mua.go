...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mua'
func (mua *mua) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mua'
func (mua *mua) FmtMonthYearMedium(t time.Time) string {
