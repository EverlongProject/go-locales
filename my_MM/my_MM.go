...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'my_MM'
func (my *my_MM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'my_MM'
func (my *my_MM) FmtMonthYearMedium(t time.Time) string {
