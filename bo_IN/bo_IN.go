...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'bo_IN'
func (bo *bo_IN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'bo_IN'
func (bo *bo_IN) FmtMonthYearMedium(t time.Time) string {
