...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_BO'
func (es *es_BO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_BO'
func (es *es_BO) FmtMonthYearMedium(t time.Time) string {
