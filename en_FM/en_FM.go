...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_FM'
func (en *en_FM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_FM'
func (en *en_FM) FmtMonthYearMedium(t time.Time) string {
