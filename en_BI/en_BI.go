...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_BI'
func (en *en_BI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_BI'
func (en *en_BI) FmtMonthYearMedium(t time.Time) string {
