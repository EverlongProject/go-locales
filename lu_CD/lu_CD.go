...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lu_CD'
func (lu *lu_CD) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lu_CD'
func (lu *lu_CD) FmtMonthYearMedium(t time.Time) string {
