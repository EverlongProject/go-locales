...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_SY'
func (ar *ar_SY) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_SY'
func (ar *ar_SY) FmtMonthYearMedium(t time.Time) string {
