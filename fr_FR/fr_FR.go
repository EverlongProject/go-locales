...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_FR'
func (fr *fr_FR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_FR'
func (fr *fr_FR) FmtMonthYearMedium(t time.Time) string {
