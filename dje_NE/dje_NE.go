...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'dje_NE'
func (dje *dje_NE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'dje_NE'
func (dje *dje_NE) FmtMonthYearMedium(t time.Time) string {
