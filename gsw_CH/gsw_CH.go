...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'gsw_CH'
func (gsw *gsw_CH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'gsw_CH'
func (gsw *gsw_CH) FmtMonthYearMedium(t time.Time) string {
