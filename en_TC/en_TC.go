...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_TC'
func (en *en_TC) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_TC'
func (en *en_TC) FmtMonthYearMedium(t time.Time) string {
