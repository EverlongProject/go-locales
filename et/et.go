...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'et'
func (et *et) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'et'
func (et *et) FmtMonthYearMedium(t time.Time) string {
