...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lkt_US'
func (lkt *lkt_US) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lkt_US'
func (lkt *lkt_US) FmtMonthYearMedium(t time.Time) string {
