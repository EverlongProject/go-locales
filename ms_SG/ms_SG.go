...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ms_SG'
func (ms *ms_SG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ms_SG'
func (ms *ms_SG) FmtMonthYearMedium(t time.Time) string {
