...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_MU'
func (fr *fr_MU) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_MU'
func (fr *fr_MU) FmtMonthYearMedium(t time.Time) string {
