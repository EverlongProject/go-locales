...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ml'
func (ml *ml) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ml'
func (ml *ml) FmtMonthYearMedium(t time.Time) string {
