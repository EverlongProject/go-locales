...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'da_DK'
func (da *da_DK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'da_DK'
func (da *da_DK) FmtMonthYearMedium(t time.Time) string {
