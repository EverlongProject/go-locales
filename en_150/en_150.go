...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_150'
func (en *en_150) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_150'
func (en *en_150) FmtMonthYearMedium(t time.Time) string {
