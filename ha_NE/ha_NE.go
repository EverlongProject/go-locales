...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ha_NE'
func (ha *ha_NE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ha_NE'
func (ha *ha_NE) FmtMonthYearMedium(t time.Time) string {
