...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_SL'
func (en *en_SL) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_SL'
func (en *en_SL) FmtMonthYearMedium(t time.Time) string {
