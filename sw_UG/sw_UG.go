...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sw_UG'
func (sw *sw_UG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sw_UG'
func (sw *sw_UG) FmtMonthYearMedium(t time.Time) string {
