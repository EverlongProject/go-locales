...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lo_LA'
func (lo *lo_LA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lo_LA'
func (lo *lo_LA) FmtMonthYearMedium(t time.Time) string {
