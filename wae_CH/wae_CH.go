...
func New() locales.Translator {
	return &wae_CH{
		...
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"", ""},
		timezones:              map[string]string{"ADT": "Atlantiši Summerzit", "AST": "Atlantiši Standardzit", "MESZ": "Mitteleuropäiši Summerzit", "MEZ": "Mitteleuropäiši Standardzit", "OESZ": "Ošteuropäiši Summerzit", "OEZ": "Ošteuropäiši Standardzit", "WESZ": "Wešteuropäiši Summerzit", "WEZ": "Wešteuropäiši Standardzit"},
	}
}
...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'wae_CH'
func (wae *wae_CH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'wae_CH'
func (wae *wae_CH) FmtMonthYearMedium(t time.Time) string {
