...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lv'
func (lv *lv) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lv'
func (lv *lv) FmtMonthYearMedium(t time.Time) string {
