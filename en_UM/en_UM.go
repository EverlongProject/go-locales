...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_UM'
func (en *en_UM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_UM'
func (en *en_UM) FmtMonthYearMedium(t time.Time) string {
