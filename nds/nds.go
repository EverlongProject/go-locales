...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nds'
func (nds *nds) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nds'
func (nds *nds) FmtMonthYearMedium(t time.Time) string {
