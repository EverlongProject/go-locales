...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'dje'
func (dje *dje) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'dje'
func (dje *dje) FmtMonthYearMedium(t time.Time) string {
