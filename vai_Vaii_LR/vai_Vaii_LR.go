...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'vai_Vaii_LR'
func (vai *vai_Vaii_LR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'vai_Vaii_LR'
func (vai *vai_Vaii_LR) FmtMonthYearMedium(t time.Time) string {
