...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lrc'
func (lrc *lrc) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lrc'
func (lrc *lrc) FmtMonthYearMedium(t time.Time) string {
