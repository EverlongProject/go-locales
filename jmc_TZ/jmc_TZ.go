...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'jmc_TZ'
func (jmc *jmc_TZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'jmc_TZ'
func (jmc *jmc_TZ) FmtMonthYearMedium(t time.Time) string {
