...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_CF'
func (fr *fr_CF) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_CF'
func (fr *fr_CF) FmtMonthYearMedium(t time.Time) string {
