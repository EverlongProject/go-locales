...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_NE'
func (fr *fr_NE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_NE'
func (fr *fr_NE) FmtMonthYearMedium(t time.Time) string {
