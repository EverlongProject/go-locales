...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'zh_Hans_MO'
func (zh *zh_Hans_MO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'zh_Hans_MO'
func (zh *zh_Hans_MO) FmtMonthYearMedium(t time.Time) string {
