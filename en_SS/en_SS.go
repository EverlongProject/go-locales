...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_SS'
func (en *en_SS) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_SS'
func (en *en_SS) FmtMonthYearMedium(t time.Time) string {
