...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'lo'
func (lo *lo) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'lo'
func (lo *lo) FmtMonthYearMedium(t time.Time) string {
