...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_PE'
func (es *es_PE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_PE'
func (es *es_PE) FmtMonthYearMedium(t time.Time) string {
