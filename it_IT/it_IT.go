...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'it_IT'
func (it *it_IT) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'it_IT'
func (it *it_IT) FmtMonthYearMedium(t time.Time) string {
