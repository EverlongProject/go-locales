...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'yue_Hans_CN'
func (yue *yue_Hans_CN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'yue_Hans_CN'
func (yue *yue_Hans_CN) FmtMonthYearMedium(t time.Time) string {
