...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_BI'
func (fr *fr_BI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_BI'
func (fr *fr_BI) FmtMonthYearMedium(t time.Time) string {
