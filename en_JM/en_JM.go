...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_JM'
func (en *en_JM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_JM'
func (en *en_JM) FmtMonthYearMedium(t time.Time) string {
