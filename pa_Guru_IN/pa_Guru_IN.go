...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pa_Guru_IN'
func (pa *pa_Guru_IN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pa_Guru_IN'
func (pa *pa_Guru_IN) FmtMonthYearMedium(t time.Time) string {
