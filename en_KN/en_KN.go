...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_KN'
func (en *en_KN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_KN'
func (en *en_KN) FmtMonthYearMedium(t time.Time) string {
