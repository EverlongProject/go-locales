...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ckb_IQ'
func (ckb *ckb_IQ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ckb_IQ'
func (ckb *ckb_IQ) FmtMonthYearMedium(t time.Time) string {
