...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kok_IN'
func (kok *kok_IN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kok_IN'
func (kok *kok_IN) FmtMonthYearMedium(t time.Time) string {
