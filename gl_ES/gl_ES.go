...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'gl_ES'
func (gl *gl_ES) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'gl_ES'
func (gl *gl_ES) FmtMonthYearMedium(t time.Time) string {
