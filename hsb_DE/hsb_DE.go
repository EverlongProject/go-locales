...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'hsb_DE'
func (hsb *hsb_DE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'hsb_DE'
func (hsb *hsb_DE) FmtMonthYearMedium(t time.Time) string {
