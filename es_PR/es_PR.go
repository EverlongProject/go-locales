...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_PR'
func (es *es_PR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_PR'
func (es *es_PR) FmtMonthYearMedium(t time.Time) string {
