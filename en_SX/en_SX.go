...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_SX'
func (en *en_SX) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_SX'
func (en *en_SX) FmtMonthYearMedium(t time.Time) string {
