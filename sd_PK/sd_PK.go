...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sd_PK'
func (sd *sd_PK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sd_PK'
func (sd *sd_PK) FmtMonthYearMedium(t time.Time) string {
