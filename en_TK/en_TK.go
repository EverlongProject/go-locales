...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_TK'
func (en *en_TK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_TK'
func (en *en_TK) FmtMonthYearMedium(t time.Time) string {
