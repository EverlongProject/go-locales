...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fa_IR'
func (fa *fa_IR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fa_IR'
func (fa *fa_IR) FmtMonthYearMedium(t time.Time) string {
