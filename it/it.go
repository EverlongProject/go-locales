...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'it'
func (it *it) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'it'
func (it *it) FmtMonthYearMedium(t time.Time) string {
