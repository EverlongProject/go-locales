...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'agq_CM'
func (agq *agq_CM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'agq_CM'
func (agq *agq_CM) FmtMonthYearMedium(t time.Time) string {
