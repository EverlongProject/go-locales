...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'zh_Hant_HK'
func (zh *zh_Hant_HK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'zh_Hant_HK'
func (zh *zh_Hant_HK) FmtMonthYearMedium(t time.Time) string {
