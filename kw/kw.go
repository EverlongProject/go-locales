...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kw'
func (kw *kw) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kw'
func (kw *kw) FmtMonthYearMedium(t time.Time) string {
