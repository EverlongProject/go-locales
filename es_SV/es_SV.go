...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_SV'
func (es *es_SV) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_SV'
func (es *es_SV) FmtMonthYearMedium(t time.Time) string {
