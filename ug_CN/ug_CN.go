...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ug_CN'
func (ug *ug_CN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ug_CN'
func (ug *ug_CN) FmtMonthYearMedium(t time.Time) string {
