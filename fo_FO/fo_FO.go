...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fo_FO'
func (fo *fo_FO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fo_FO'
func (fo *fo_FO) FmtMonthYearMedium(t time.Time) string {
