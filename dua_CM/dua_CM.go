...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'dua_CM'
func (dua *dua_CM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'dua_CM'
func (dua *dua_CM) FmtMonthYearMedium(t time.Time) string {
