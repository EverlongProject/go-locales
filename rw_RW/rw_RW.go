...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'rw_RW'
func (rw *rw_RW) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'rw_RW'
func (rw *rw_RW) FmtMonthYearMedium(t time.Time) string {
