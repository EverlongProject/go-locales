...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'so'
func (so *so) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'so'
func (so *so) FmtMonthYearMedium(t time.Time) string {
