...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_US_POSIX'
func (en *en_US_POSIX) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_US_POSIX'
func (en *en_US_POSIX) FmtMonthYearMedium(t time.Time) string {
