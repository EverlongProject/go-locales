...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_RW'
func (fr *fr_RW) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_RW'
func (fr *fr_RW) FmtMonthYearMedium(t time.Time) string {
