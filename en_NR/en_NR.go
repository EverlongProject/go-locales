...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_NR'
func (en *en_NR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_NR'
func (en *en_NR) FmtMonthYearMedium(t time.Time) string {
