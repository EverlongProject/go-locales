...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'se_NO'
func (se *se_NO) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'se_NO'
func (se *se_NO) FmtMonthYearMedium(t time.Time) string {
