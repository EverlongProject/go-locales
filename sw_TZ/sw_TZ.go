...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sw_TZ'
func (sw *sw_TZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sw_TZ'
func (sw *sw_TZ) FmtMonthYearMedium(t time.Time) string {
