...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sl'
func (sl *sl) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sl'
func (sl *sl) FmtMonthYearMedium(t time.Time) string {
