...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'jv_ID'
func (jv *jv_ID) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'jv_ID'
func (jv *jv_ID) FmtMonthYearMedium(t time.Time) string {
