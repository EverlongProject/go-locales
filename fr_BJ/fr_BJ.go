...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_BJ'
func (fr *fr_BJ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_BJ'
func (fr *fr_BJ) FmtMonthYearMedium(t time.Time) string {
