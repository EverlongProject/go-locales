...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ebu_KE'
func (ebu *ebu_KE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ebu_KE'
func (ebu *ebu_KE) FmtMonthYearMedium(t time.Time) string {
