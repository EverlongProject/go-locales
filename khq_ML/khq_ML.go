...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'khq_ML'
func (khq *khq_ML) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'khq_ML'
func (khq *khq_ML) FmtMonthYearMedium(t time.Time) string {
