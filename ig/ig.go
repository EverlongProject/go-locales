...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ig'
func (ig *ig) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ig'
func (ig *ig) FmtMonthYearMedium(t time.Time) string {
