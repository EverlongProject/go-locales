...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'vai_Vaii'
func (vai *vai_Vaii) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'vai_Vaii'
func (vai *vai_Vaii) FmtMonthYearMedium(t time.Time) string {
