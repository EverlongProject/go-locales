...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'uz_Arab_AF'
func (uz *uz_Arab_AF) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'uz_Arab_AF'
func (uz *uz_Arab_AF) FmtMonthYearMedium(t time.Time) string {
