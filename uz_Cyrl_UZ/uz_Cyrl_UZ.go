...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'uz_Cyrl_UZ'
func (uz *uz_Cyrl_UZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'uz_Cyrl_UZ'
func (uz *uz_Cyrl_UZ) FmtMonthYearMedium(t time.Time) string {
