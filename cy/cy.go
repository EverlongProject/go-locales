...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'cy'
func (cy *cy) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'cy'
func (cy *cy) FmtMonthYearMedium(t time.Time) string {
