...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'pt_MZ'
func (pt *pt_MZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'pt_MZ'
func (pt *pt_MZ) FmtMonthYearMedium(t time.Time) string {
