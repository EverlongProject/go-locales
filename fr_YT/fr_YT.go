...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_YT'
func (fr *fr_YT) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_YT'
func (fr *fr_YT) FmtMonthYearMedium(t time.Time) string {
