...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'rm_CH'
func (rm *rm_CH) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'rm_CH'
func (rm *rm_CH) FmtMonthYearMedium(t time.Time) string {
