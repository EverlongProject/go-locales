...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_DG'
func (en *en_DG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_DG'
func (en *en_DG) FmtMonthYearMedium(t time.Time) string {
