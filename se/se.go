...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'se'
func (se *se) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'se'
func (se *se) FmtMonthYearMedium(t time.Time) string {
