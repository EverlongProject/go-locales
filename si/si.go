...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'si'
func (si *si) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'si'
func (si *si) FmtMonthYearMedium(t time.Time) string {
