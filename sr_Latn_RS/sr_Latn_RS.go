...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sr_Latn_RS'
func (sr *sr_Latn_RS) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sr_Latn_RS'
func (sr *sr_Latn_RS) FmtMonthYearMedium(t time.Time) string {
