...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'rof'
func (rof *rof) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'rof'
func (rof *rof) FmtMonthYearMedium(t time.Time) string {
