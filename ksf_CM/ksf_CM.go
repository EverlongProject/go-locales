...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ksf_CM'
func (ksf *ksf_CM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ksf_CM'
func (ksf *ksf_CM) FmtMonthYearMedium(t time.Time) string {
