...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'hu'
func (hu *hu) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'hu'
func (hu *hu) FmtMonthYearMedium(t time.Time) string {
