...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'qu_PE'
func (qu *qu_PE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'qu_PE'
func (qu *qu_PE) FmtMonthYearMedium(t time.Time) string {
