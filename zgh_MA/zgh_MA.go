...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'zgh_MA'
func (zgh *zgh_MA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'zgh_MA'
func (zgh *zgh_MA) FmtMonthYearMedium(t time.Time) string {
