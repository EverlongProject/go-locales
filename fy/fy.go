...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fy'
func (fy *fy) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fy'
func (fy *fy) FmtMonthYearMedium(t time.Time) string {
