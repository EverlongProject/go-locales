...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'chr'
func (chr *chr) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'chr'
func (chr *chr) FmtMonthYearMedium(t time.Time) string {
