...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_RE'
func (fr *fr_RE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_RE'
func (fr *fr_RE) FmtMonthYearMedium(t time.Time) string {
