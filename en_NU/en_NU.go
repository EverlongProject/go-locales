...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_NU'
func (en *en_NU) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_NU'
func (en *en_NU) FmtMonthYearMedium(t time.Time) string {
