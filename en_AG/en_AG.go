...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_AG'
func (en *en_AG) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_AG'
func (en *en_AG) FmtMonthYearMedium(t time.Time) string {
