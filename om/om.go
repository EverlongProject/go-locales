...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'om'
func (om *om) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'om'
func (om *om) FmtMonthYearMedium(t time.Time) string {
