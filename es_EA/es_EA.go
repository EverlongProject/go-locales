...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_EA'
func (es *es_EA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_EA'
func (es *es_EA) FmtMonthYearMedium(t time.Time) string {
