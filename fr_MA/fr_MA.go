...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'fr_MA'
func (fr *fr_MA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'fr_MA'
func (fr *fr_MA) FmtMonthYearMedium(t time.Time) string {
