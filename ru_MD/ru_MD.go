...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ru_MD'
func (ru *ru_MD) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ru_MD'
func (ru *ru_MD) FmtMonthYearMedium(t time.Time) string {
