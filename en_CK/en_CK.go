...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_CK'
func (en *en_CK) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_CK'
func (en *en_CK) FmtMonthYearMedium(t time.Time) string {
