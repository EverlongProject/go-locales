...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'luo'
func (luo *luo) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'luo'
func (luo *luo) FmtMonthYearMedium(t time.Time) string {
