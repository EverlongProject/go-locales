...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'naq_NA'
func (naq *naq_NA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'naq_NA'
func (naq *naq_NA) FmtMonthYearMedium(t time.Time) string {
