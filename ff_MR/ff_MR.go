...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ff_MR'
func (ff *ff_MR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ff_MR'
func (ff *ff_MR) FmtMonthYearMedium(t time.Time) string {
