...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nl_CW'
func (nl *nl_CW) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nl_CW'
func (nl *nl_CW) FmtMonthYearMedium(t time.Time) string {
