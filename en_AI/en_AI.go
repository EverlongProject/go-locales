...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_AI'
func (en *en_AI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_AI'
func (en *en_AI) FmtMonthYearMedium(t time.Time) string {
