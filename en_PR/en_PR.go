...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_PR'
func (en *en_PR) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_PR'
func (en *en_PR) FmtMonthYearMedium(t time.Time) string {
