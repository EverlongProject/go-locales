...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'zu_ZA'
func (zu *zu_ZA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'zu_ZA'
func (zu *zu_ZA) FmtMonthYearMedium(t time.Time) string {
