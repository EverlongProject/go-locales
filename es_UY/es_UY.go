...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_UY'
func (es *es_UY) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_UY'
func (es *es_UY) FmtMonthYearMedium(t time.Time) string {
