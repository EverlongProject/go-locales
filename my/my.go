...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'my'
func (my *my) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'my'
func (my *my) FmtMonthYearMedium(t time.Time) string {
	...
	b = append(b, []byte{0xe1, 0x81, 0x8a}...)
	b = append(b, my.monthsAbbreviated[t.Month()]...)
