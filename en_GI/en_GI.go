...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_GI'
func (en *en_GI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_GI'
func (en *en_GI) FmtMonthYearMedium(t time.Time) string {
