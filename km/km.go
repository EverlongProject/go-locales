...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'km'
func (km *km) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'km'
func (km *km) FmtMonthYearMedium(t time.Time) string {
