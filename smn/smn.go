...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'smn'
func (smn *smn) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'smn'
func (smn *smn) FmtMonthYearMedium(t time.Time) string {
