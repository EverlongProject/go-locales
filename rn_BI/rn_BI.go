...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'rn_BI'
func (rn *rn_BI) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'rn_BI'
func (rn *rn_BI) FmtMonthYearMedium(t time.Time) string {
