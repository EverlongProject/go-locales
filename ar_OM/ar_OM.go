...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ar_OM'
func (ar *ar_OM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ar_OM'
func (ar *ar_OM) FmtMonthYearMedium(t time.Time) string {
