...
func New() locales.Translator {
	return &ln_CF{
		...
		timezones:              map[string]string{"CAT": "Ntángo ya Lubumbashi", "EAT": "Ntángo ya Afríka ya Ɛ́sita", "GMT": "Ntángo ya Londoni", "SAST": "Ntángo ya Afríka ya Sidi"},
	}
}
...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ln_CF'
func (ln *ln_CF) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ln_CF'
func (ln *ln_CF) FmtMonthYearMedium(t time.Time) string {
