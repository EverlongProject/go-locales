...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_WS'
func (en *en_WS) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_WS'
func (en *en_WS) FmtMonthYearMedium(t time.Time) string {
