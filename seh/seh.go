...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'seh'
func (seh *seh) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'seh'
func (seh *seh) FmtMonthYearMedium(t time.Time) string {
