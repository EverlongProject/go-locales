...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'dyo'
func (dyo *dyo) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'dyo'
func (dyo *dyo) FmtMonthYearMedium(t time.Time) string {
