...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'en_IM'
func (en *en_IM) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'en_IM'
func (en *en_IM) FmtMonthYearMedium(t time.Time) string {
