...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mer_KE'
func (mer *mer_KE) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mer_KE'
func (mer *mer_KE) FmtMonthYearMedium(t time.Time) string {
