...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'it_VA'
func (it *it_VA) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'it_VA'
func (it *it_VA) FmtMonthYearMedium(t time.Time) string {
