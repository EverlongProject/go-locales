...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'khq'
func (khq *khq) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'khq'
func (khq *khq) FmtMonthYearMedium(t time.Time) string {
