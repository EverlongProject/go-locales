...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'zh'
func (zh *zh) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'zh'
func (zh *zh) FmtMonthYearMedium(t time.Time) string {
