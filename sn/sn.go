...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'sn'
func (sn *sn) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'sn'
func (sn *sn) FmtMonthYearMedium(t time.Time) string {
