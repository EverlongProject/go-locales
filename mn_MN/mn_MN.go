...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mn_MN'
func (mn *mn_MN) FmtMonthDayMedium(t time.Time) string {

	b := make([]byte, 0, 32)

	b = append(b, []byte{0xc3, 0x90, 0xc2, 0xbe, 0xc3, 0x90, 0xc2, 0xbd, 0xc3, 0x91, 0xc2, 0x8b}...)
	b = append(b, mn.monthsAbbreviated[t.Month()]...)
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mn_MN'
func (mn *mn_MN) FmtMonthYearMedium(t time.Time) string {
