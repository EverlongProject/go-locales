...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'ko_KP'
func (ko *ko_KP) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'ko_KP'
func (ko *ko_KP) FmtMonthYearMedium(t time.Time) string {
