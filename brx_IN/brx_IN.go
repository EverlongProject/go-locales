...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'brx_IN'
func (brx *brx_IN) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'brx_IN'
func (brx *brx_IN) FmtMonthYearMedium(t time.Time) string {
