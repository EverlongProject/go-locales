...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'nl_SX'
func (nl *nl_SX) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'nl_SX'
func (nl *nl_SX) FmtMonthYearMedium(t time.Time) string {
