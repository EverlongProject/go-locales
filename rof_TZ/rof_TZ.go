...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'rof_TZ'
func (rof *rof_TZ) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'rof_TZ'
func (rof *rof_TZ) FmtMonthYearMedium(t time.Time) string {
