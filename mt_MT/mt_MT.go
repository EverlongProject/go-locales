...
func New() locales.Translator {
	return &mt_MT{
		...
		timezones:          map[string]string{"MESZ": "Ħin Ċentrali Ewropew tas-Sajf", "MEZ": "Ħin Ċentrali Ewropew Standard"},
	}
}
...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mt_MT'
func (mt *mt_MT) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mt_MT'
func (mt *mt_MT) FmtMonthYearMedium(t time.Time) string {
