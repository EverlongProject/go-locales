...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'de_IT'
func (de *de_IT) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'de_IT'
func (de *de_IT) FmtMonthYearMedium(t time.Time) string {
