...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'kk_KZ'
func (kk *kk_KZ) FmtMonthDayMedium(t time.Time) string {

	b := make([]byte, 0, 32)

	b = append(b, []byte{0xd0, 0xb6}...)
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'kk_KZ'
func (kk *kk_KZ) FmtMonthYearMedium(t time.Time) string {
	...
	b = append(b, []byte{0x20, 0xd0, 0xb6}...)
	b = append(b, []byte{0x2e, 0x20, 0x20}...)
	b = append(b, kk.monthsAbbreviated[t.Month()]...)
