...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'es_EC'
func (es *es_EC) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'es_EC'
func (es *es_EC) FmtMonthYearMedium(t time.Time) string {
