...
// FmtMonthDayMedium returns the medium date month and day representation of 't' for 'mgo'
func (mgo *mgo) FmtMonthDayMedium(t time.Time) string {
...
// FmtMonthYearMedium returns the medium date month and year representation of 't' for 'mgo'
func (mgo *mgo) FmtMonthYearMedium(t time.Time) string {
